...
argument_list|()
decl_stmt|;
comment|// write the document to the blob
name|XMLWriter
name|writer
init|=
operator|new
...
expr_stmt|;
return|return;
comment|/*         			throw new HibernateException("JDBC connection object must be a oracle.jdbc.OracleConnection. " +         					"Connection class is " + conn.getClass().getName());                             */
block|}
name|arglist
index|[
literal|0
...
operator|)
return|;
comment|//return ((Document)x).equals((Document)y);
block|}
specifier|public
name|Serializable
name|disassemble
