...
block|}
decl_stmt|;
comment|// I think I end up not using the BAD_ENCODING indicator.
comment|//private final static byte BAD_ENCODING    = -9; // Indicates error in encoding
specifier|private
specifier|final
specifier|static
name|byte
...
argument_list|)
expr_stmt|;
comment|//out.write( Base64.decode4to3( buffer ) );
name|position
operator|=
literal|0
expr_stmt|;
