...
block|{
return|return
literal|"<a class='noFancyLinks' onMouseOver=\"this.style.cursor='hand';this.style.cursor='pointer';\" onClick=\"window.open('suggestions.do?id="
operator|+
name|iClassId
operator|+
...
operator|)
decl_stmt|;
comment|/* 			StringBuffer sb = null; 			if (link) { 				sb = new StringBuffer("suggestions.do?id="+iClass.getClassId()); 				for (int i=0;i<iRoom.length;i++) { 					sb.append("&room"+i+"="+iRoom[i].getId()); 				} 				sb.append("&days="+iDays+"&slot="+iStartSlot+"&pattern="+iPatternId+"&op=Try"); 			}*/
return|return
operator|(
name|link
condition|?
