...
argument_list|)
expr_stmt|;
comment|/*         UserData.setProperty(session,"SuggestionsModel.filterText", getFilterText());         UserData.setPropertyInt(session,"SuggestionsModel.filter", getFilter());         UserData.setPropertyInt(session,"SuggestionsModel.minRoomSize", getMinRoomSize());         UserData.setPropertyInt(session,"SuggestionsModel.maxRoomSize", getMaxRoomSize());         */
block|}
specifier|public
name|void
name|load
...
argument_list|)
expr_stmt|;
comment|/*         setFilterText(UserData.getProperty(session,"SuggestionsModel.filterText", getFilterText()));         setFilter(UserData.getPropertyInt(session,"SuggestionsModel.filter", getFilter()));         setMinRoomSize(UserData.getPropertyInt(session,"SuggestionsModel.minRoomSize", getMinRoomSize()));         setMaxRoomSize(UserData.getPropertyInt(session,"SuggestionsModel.maxRoomSize", getMaxRoomSize()));         */
block|}
specifier|public
name|String
name|toString
