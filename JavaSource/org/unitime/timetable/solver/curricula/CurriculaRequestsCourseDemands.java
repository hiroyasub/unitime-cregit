...
name|select
init|=
literal|"f.code, co, m.code, s.uniqueId"
decl_stmt|;
name|String
name|from
init|=
literal|"CourseRequest r inner join r.courseOffering co inner join r.courseDemand.student s inner join s.academicAreaClassifications a inner join a.academicClassification f"
decl_stmt|;
name|String
name|where
init|=
literal|"s.session.uniqueId = :sessionId and a.academicArea.uniqueId = :acadAreaId"
decl_stmt|;
name|String
name|mCode
init|=
