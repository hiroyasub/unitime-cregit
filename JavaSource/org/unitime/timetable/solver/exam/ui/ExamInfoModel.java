...
name|b
operator|+=
literal|" and r.examType in ("
operator|+
name|Location
operator|.
name|sExamLocationTypeFinal
operator|+
literal|","
operator|+
name|Location
operator|.
name|sExamLocationTypeBoth
operator|+
literal|")"
expr_stmt|;
break|break;
...
name|b
operator|+=
literal|" and r.examType != "
operator|+
name|Location
operator|.
name|sExamLocationTypeNone
expr_stmt|;
block|}
return|return
operator|new
