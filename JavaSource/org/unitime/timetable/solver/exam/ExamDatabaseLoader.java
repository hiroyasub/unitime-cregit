...
argument_list|()
expr_stmt|;
comment|/*             if (org.unitime.timetable.model.Exam.sExamTypeMidterm==iExamType)                 loadAvailabilitiesFromEvents();//loadAvailabilities();                 */
if|if
condition|(
name|org
operator|.
...
specifier|protected
name|void
name|loadAvailabilities
parameter_list|()
block|{
name|List
name|committedAssignments
init|=
operator|new
name|ExamDAO
argument_list|()
...
name|createQuery
argument_list|(
literal|"select a from Assignment a where a.solution.commited=true and "
operator|+
literal|"a.solution.owner.session.uniqueId=:sessionId"
argument_list|)
operator|.
name|setLong
argument_list|(
...
name|createQuery
argument_list|(
literal|"select e.student.uniqueId from "
operator|+
literal|"StudentClassEnrollment e where e.clazz.uniqueId=:classId"
argument_list|)
operator|.
name|setLong
argument_list|(
