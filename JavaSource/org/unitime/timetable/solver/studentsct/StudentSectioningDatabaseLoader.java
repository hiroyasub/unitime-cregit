...
name|setPhase
argument_list|(
literal|"Computing last-like request weights..."
argument_list|,
literal|2
operator|*
name|getModel
...
name|setPhase
argument_list|(
literal|"Loading last-like class assignments..."
argument_list|,
name|enrollments
operator|.
name|size
...
name|setPhase
argument_list|(
literal|"Loading last-like course requests..."
argument_list|,
name|enrollments
operator|.
name|size
...
name|setPhase
argument_list|(
literal|"Assigning course requests..."
argument_list|,
name|getModel
argument_list|()
operator|.
...
name|setPhase
argument_list|(
literal|"Assigning free-time requests..."
argument_list|,
name|getModel
argument_list|()
operator|.
