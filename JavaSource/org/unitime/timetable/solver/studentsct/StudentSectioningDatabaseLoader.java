...
name|iLoadStudentInfo
condition|?
literal|"left join fetch s.academicAreaClassifications as a left join fetch s.posMajors as mj left join fetch s.groups as g "
else|:
literal|""
operator|)
operator|+
...
name|createQuery
argument_list|(
literal|"select p from DistributionPref p, Department d where p.distributionType.reference=:ref and d.session.uniqueId = :sessionId"
operator|+
...
name|setPhase
argument_list|(
literal|"Loading linked sections..."
argument_list|,
name|linkedSectionsPrefs
operator|.
name|size
