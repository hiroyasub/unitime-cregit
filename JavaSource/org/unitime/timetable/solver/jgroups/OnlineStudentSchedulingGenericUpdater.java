...
decl_stmt|;
specifier|private
name|CoordinatorAcquiringThread
name|iCoordinator
decl_stmt|;
specifier|public
name|OnlineStudentSchedulingGenericUpdater
...
name|setName
argument_list|(
literal|"Updater[generic]:AcquiringCoordinatorLock"
argument_list|)
expr_stmt|;
name|setDaemon
argument_list|(
...
name|getLock
argument_list|(
literal|"updater[generic].coordinator"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|info
argument_list|(
literal|"Waiting for a coordinator lock..."
argument_list|)
expr_stmt|;
name|iLock
operator|.
...
name|info
argument_list|(
literal|"I am no longer the coordinator."
argument_list|)
expr_stmt|;
block|}
block|}
...
name|info
argument_list|(
literal|"No longer looking for a coordinator."
argument_list|)
expr_stmt|;
block|}
specifier|public
...
specifier|public
name|void
name|releaseCoordinatorLockIfHeld
parameter_list|()
block|{
if|if
condition|(
