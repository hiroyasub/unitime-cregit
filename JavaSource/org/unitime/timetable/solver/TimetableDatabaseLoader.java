...
specifier|private
name|boolean
name|iWeakenDistributions
init|=
literal|false
decl_stmt|;
specifier|private
name|boolean
name|iSoftInstructorConstraints
init|=
literal|false
decl_stmt|;
specifier|private
name|boolean
name|iAllowProhibitedRooms
init|=
literal|false
decl_stmt|;
specifier|private
...
name|getPropertyBoolean
argument_list|(
literal|"General.MPP.FixedTimes"
argument_list|,
name|iFixedTimesMPP
argument_list|)
expr_stmt|;
...
name|getPropertyBoolean
argument_list|(
literal|"General.WeakenDistributions"
argument_list|,
name|iWeakenDistributions
argument_list|)
expr_stmt|;
...
name|getPropertyBoolean
argument_list|(
literal|"General.SoftInstructorConstraints"
argument_list|,
name|iSoftInstructorConstraints
argument_list|)
expr_stmt|;
...
name|getPropertyBoolean
argument_list|(
literal|"General.AllowProhibitedRooms"
argument_list|,
name|iAllowProhibitedRooms
argument_list|)
expr_stmt|;
...
name|getProperty
argument_list|(
literal|"Load.OnlineOnlyStudentSuffix"
argument_list|,
literal|"OL"
argument_list|)
expr_stmt|;
...
name|trace
argument_list|(
literal|"time pattern has required times"
argument_list|)
expr_stmt|;
block|}
name|ClassDurationType
...
operator|+
literal|"where ci.lead = true and i.externalUniqueId in :puids and a.solution.owner.session.uniqueId=:sessionId and a.solution.commited=true and a.solution.owner.uniqueId not in ("
operator|+
name|iSolverGroupIds
operator|+
literal|")"
...
operator|+
literal|"where s.session.uniqueId = :sessionId and s.externalUniqueId in :puids"
argument_list|)
operator|.
name|setLong
argument_list|(
