...
comment|// otherwise if !hasSubpartReservation>> there is reservation on some other subpoart --> can attend any of the classes of this subpart
if|if
condition|(
operator|!
name|hasConfigReservation
...
argument_list|)
argument_list|,
literal|"Failed to parse automatic hierarchical constraint type "
operator|+
name|automaticHierarchicalConstraints
argument_list|)
expr_stmt|;
