...
parameter_list|)
block|{
comment|// Check if the solution is the best ever found one
if|if
condition|(
...
block|{
comment|// If the solver is not able to improve solution in the last 5000 iterations, take the best one and try to fix it
if|if
condition|(
name|iCurrentSolution
operator|.
...
argument_list|()
operator|.
name|getBestUnassignedVariables
argument_list|()
operator|>
literal|0
operator|&&
...
name|getProperty
argument_list|(
literal|"tmtbl.solver.export.folder"
argument_list|,
name|System
operator|.
name|getProperty
...
name|getProperty
argument_list|(
literal|"tmtbl.solver.export.id-conv"
argument_list|,
literal|"true"
argument_list|)
argument_list|)
...
argument_list|)
expr_stmt|;
comment|//System.setProperty("IdConvertor.File",getProperties().getProperty("Xml.IdConv"));
block|}
name|TimetableXMLSaver
name|saver
init|=
