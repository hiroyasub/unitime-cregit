...
name|iModel
operator|.
name|getCommittedStudentConflictsCounter
argument_list|()
operator|.
name|get
argument_list|()
...
name|iModel
operator|.
name|getViolatedCommitttedStudentConflictsCounter
argument_list|()
operator|.
name|get
argument_list|()
...
name|warn
argument_list|(
literal|"Inconsistent number of committed student course conflits (counter="
operator|+
name|iModel
operator|.
name|getCommitedStudentConflicts
