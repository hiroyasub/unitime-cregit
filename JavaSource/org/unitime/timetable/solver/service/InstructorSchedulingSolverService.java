...
argument_list|(
literal|"org/cpsolver/instructor/default.properties"
argument_list|)
decl_stmt|;
if|if
condition|(
...
name|warn
argument_list|(
literal|"Failed to load configuration defaults:"
operator|+
name|e
operator|.
name|getMessage
...
argument_list|)
expr_stmt|;
comment|// String.valueOf(Math.max(1, Runtime.getRuntime().availableProcessors() / 2))
block|}
name|properties
operator|.
name|setProperty
