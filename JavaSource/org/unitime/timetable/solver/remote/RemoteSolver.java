...
name|startsWith
argument_list|(
literal|"log4j.appender.unitime"
argument_list|)
operator|||
operator|(
name|name
...
name|getProperty
argument_list|(
literal|"tmtbl.solver.connection.url"
argument_list|)
operator|!=
literal|null
condition|)
...
name|fatal
argument_list|(
literal|"Solver initialization failed"
argument_list|,
name|e
argument_list|)
expr_stmt|;
