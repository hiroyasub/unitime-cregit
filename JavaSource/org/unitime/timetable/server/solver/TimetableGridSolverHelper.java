...
name|createQuery
argument_list|(
literal|"select ci.responsibility from ClassInstructor ci where "
operator|+
literal|"ci.classInstructing.uniqueId = :classId and ci.instructor.uniqueId = :instructorId"
argument_list|)
operator|.
name|setLong
argument_list|(
...
literal|"select ci.responsibility from ClassInstructor ci where "
operator|+
literal|"ci.classInstructing.uniqueId = :classId and ci.instructor.externalUniqueId = :extId"
argument_list|)
operator|.
name|setLong
argument_list|(
