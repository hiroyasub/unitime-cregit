...
operator|+
literal|"i.department.session.uniqueId = :sessionId and i.teachingPreference.prefProlog != :prohibited and i.maxLoad> 0.0"
argument_list|)
operator|.
name|setLong
argument_list|(
...
parameter_list|)
block|{
comment|// int nrInstructors = nrInstructorsNeeded(clazz);
comment|// if (nrInstructors<= 0) return null;
name|TeachingRequestInfo
name|request
init|=
operator|new
