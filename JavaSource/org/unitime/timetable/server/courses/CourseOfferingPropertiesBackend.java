...
condition|)
block|{
comment|// edit -- must have at least one edit permission
if|if
condition|(
operator|!
name|context
...
block|{
comment|// check Add permission otherwise (the user has at least one subject area for which he/she can add a course)
name|context
operator|.
name|checkPermission
argument_list|(
...
name|append
argument_list|(
literal|" and i.externalFundingDept = 1"
argument_list|)
expr_stmt|;
name|StringBuffer
name|query2
