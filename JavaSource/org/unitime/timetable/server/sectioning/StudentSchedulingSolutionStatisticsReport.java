...
block|,
literal|"- students with a free time conflict"
block|,
literal|"- average minutes"
block|,
literal|"- students with a course time conflict"
block|,
literal|"- average minutes"
block|}
argument_list|,
...
block|,
literal|"For those with a free time conflict, the average number of overlapping minutes"
block|,
literal|"Total number of students with a course conflict"
block|,
literal|"For those with a course time conflict, the average number of overlapping minutes"
block|}
argument_list|,
operator|new
name|Statistic
...
operator|++
expr_stmt|;
comment|/*                         	if (group == StudentGroup.REBATCH) {                         		System.out.println(student.getExternalId() + ": " + student.getName() + " [" + sections + "]");                         		for (AreaClassificationMajor acm: student.getAreaClassificationMajors()) {                         			System.out.println("-- " + acm.getArea() + "/" + acm.getMajor() + " " + acm.getClassification());                                 }                         		for (AcademicAreaCode aac: student.getMinors()) {                         			System.out.println("-- " + aac.getCode());                         		}                         	}                         	*/
block|}
else|else
block|{
comment|/*                         	if (group == StudentGroup.SCONTONL || group == StudentGroup.SCOVIDONL) {                         		System.out.println(student.getExternalId() + ": " + student.getName() + " [" + sections + "]");                         		for (AreaClassificationMajor acm: student.getAreaClassificationMajors()) {                         			System.out.println("-- " + acm.getArea() + "/" + acm.getMajor() + " " + acm.getClassification());                                 }                         		for (AcademicAreaCode aac: student.getMinors()) {                         			System.out.println("-- " + aac.getCode());                         		}                         	}*/
block|}
if|if
condition|(
name|onlineSections
