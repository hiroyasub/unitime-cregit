...
name|Service
argument_list|(
literal|"org.unitime.timetable.gwt.shared.ReservationInterface$ReservationFilterRpcRequest"
argument_list|)
specifier|public
class|class
...
literal|"department"
argument_list|,
literal|"co.subjectArea.department.uniqueId in ("
operator|+
name|deptIds
operator|+
literal|")"
...
literal|"subject"
argument_list|,
literal|"co.subjectArea.subjectAreaAbbreviation in ("
operator|+
name|subjects
operator|+
literal|")"
...
literal|"area"
argument_list|,
literal|"r.area.academicAreaAbbreviation in ("
operator|+
name|areas
operator|+
literal|")"
...
literal|"group"
argument_list|,
literal|"r.group.groupAbbreviation in ("
operator|+
name|groups
operator|+
literal|")"
