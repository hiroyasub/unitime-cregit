...
name|Exception
argument_list|(
literal|"Given XML file is not a Last Like Course Demand load file."
argument_list|)
throw|;
block|}
name|String
...
name|Exception
argument_list|(
literal|"Student with external Id = "
operator|+
name|externalId
operator|+
...
name|createQuery
argument_list|(
literal|"select distinct a from SubjectArea as a where a.subjectAreaAbbreviation=:subjectAreaAbbv and a.session.uniqueId=:sessionId"
argument_list|)
operator|.
name|setLong
argument_list|(
