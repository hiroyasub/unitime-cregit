...
name|Exception
argument_list|(
literal|"Given XML file is not a PosMinor load file."
argument_list|)
throw|;
block|}
try|try
...
name|createQuery
argument_list|(
literal|"select distinct a from PosMinor as a where a.externalUniqueId=:externalId and a.session.uniqueId=:sessionId"
argument_list|)
operator|.
name|setLong
argument_list|(
