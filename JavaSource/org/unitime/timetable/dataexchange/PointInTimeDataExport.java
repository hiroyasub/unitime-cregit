...
name|append
argument_list|(
literal|" and cco.uniqueId = io.ctrlCourseId"
argument_list|)
operator|.
name|append
argument_list|(
...
name|append
argument_list|(
literal|" left join fetch s.academicAreaClassifications as aac"
argument_list|)
operator|.
name|append
argument_list|(
literal|" left join fetch s.posMajors as ma"
argument_list|)
operator|.
name|append
argument_list|(
literal|" left join fetch s.posMinors as mi"
argument_list|)
operator|.
name|append
argument_list|(
...
name|info
argument_list|(
literal|"Warning - Not enough 5 minute periods will be stored for meeting: "
operator|+
name|meeting
operator|.
name|getUniqueId
...
name|info
argument_list|(
literal|"Info - More than enough 5 minute periods for meeting:  "
operator|+
name|meeting
operator|.
name|getUniqueId
...
name|toString
argument_list|(
name|calculateNormalizedPercentShareForInstructor
argument_list|(
name|instructor
argument_list|)
argument_list|)
