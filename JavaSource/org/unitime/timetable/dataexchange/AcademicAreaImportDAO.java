...
name|Exception
argument_list|(
literal|"Given XML file is not an AcademicArea load file."
argument_list|)
throw|;
block|}
name|String
...
name|createQuery
argument_list|(
literal|"select distinct a from AcademicArea as a where a.externalUniqueId=:externalId and a.session.uniqueId=:sessionId"
argument_list|)
operator|.
name|setLong
argument_list|(
