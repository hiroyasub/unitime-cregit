...
specifier|private
name|CourseOffering
name|findCourseOfferingWithUniqueId
parameter_list|(
name|Long
name|uniqueId
parameter_list|,
...
name|addNote
argument_list|(
literal|"\tMultiple meets with preferences exist -- deleted them"
argument_list|)
expr_stmt|;
for|for
control|(
...
argument_list|()
operator|+
literal|" is no longer a meets with, removed"
operator|+
name|dp
operator|.
name|toString
...
name|addNote
argument_list|(
literal|"\tfound multiple matching events, deleting them and adding new event: "
operator|+
name|c
operator|.
name|getSchedulingSubpart
...
comment|//            ChangeLog.addChange(getHibSession(), manager, session, io, ChangeLog.Source.DATA_IMPORT_OFFERINGS, ChangeLog.Operation.DELETE, io.getControllingCourseOffering().getSubjectArea(), null);
comment|//        }
block|}
specifier|private
name|void
...
name|createQuery
argument_list|(
literal|"from EventType et where et.reference = 'class'"
argument_list|)
operator|.
name|uniqueResult
argument_list|()
...
argument_list|)
argument_list|,
literal|"Timetabling (Data Import): "
operator|+
name|subject
argument_list|,
name|mail
