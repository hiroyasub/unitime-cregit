...
comment|//            ChangeLog.addChange(getHibSession(), manager, session, io, ChangeLog.Source.DATA_IMPORT, ChangeLog.Operation.DELETE, io.getControllingCourseOffering().getSubjectArea(), null);
comment|//        }
block|}
specifier|private
name|void
