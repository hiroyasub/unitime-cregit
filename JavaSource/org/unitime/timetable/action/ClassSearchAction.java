...
name|setProperty
argument_list|(
literal|"ClassList.fundingDepartment"
argument_list|,
name|classListForm
operator|.
...
expr_stmt|;
block|}
comment|/* 	        if (ApplicationProperty.CoursesFundingDepartmentsEnabled.isTrue()) { 	        	query.append(" and (c.fundingDeptId is not null or c.managingDept in co.subjectArea.department)"); 	        } 	        */
comment|/*if (fetchFundingDepartment) { 				query.append("left join fetch c.fundingDept as fd ");  			}*/
if|if
condition|(
name|fetchPreferences
condition|)
