...
argument_list|)
decl_stmt|;
comment|/* 	protected Map getKeyMethodMap() { 	      Map map = new HashMap(); 	      map.put("button.searchClasses", "searchClasses"); 	      map.put("button.exportPDF", "exportPdf"); //	      map.put("button.cancel", "searchClasses"); 	      return map; 	} 	*/
...
argument_list|)
expr_stmt|;
comment|//query.append (" where c.schedulingSubpart in ( select ss2 from SchedulingSubpart as ss2 inner join ss2.instrOfferingConfig.instructionalOffering.courseOfferings as co2 ");
name|query
operator|.
name|append
argument_list|(
