...
operator|+
literal|"document.location='manageSolvers.do?op=Unload&puid="
operator|+
name|properties
operator|.
name|getProperty
...
condition|)
block|{
comment|// String op="<input type=\"button\" value=\"Disconnect\" onClick=\"if (confirm('Do you really want to disconnect server "+server.getHost()+"?')) document.location='manageSolvers.do?op=Disconnect&solver="+server.getHost()+"';\">";
name|webTable
operator|.
name|addLine
argument_list|(
...
literal|"if (confirm('Do you really want to unload this solver?')) "
operator|+
literal|"document.location='manageSolvers.do?op=Unload&examPuid="
operator|+
name|properties
operator|.
name|getProperty
...
literal|"if (confirm('Do you really want to unload this solver?')) "
operator|+
literal|"document.location='manageSolvers.do?op=Unload&sectionPuid="
operator|+
name|properties
operator|.
name|getProperty
