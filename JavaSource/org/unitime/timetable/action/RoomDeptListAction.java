...
begin_comment
comment|/**   * MyEclipse Struts  * Creation date: 05-05-2006  *   * XDoclet definition:  * @struts.action path="/roomDeptList" name="roomDeptListForm" input="/admin/roomDeptList.jsp" parameter="doit" scope="request" validate="true"  * @struts.action-forward name="showRoomDeptList" path="roomDeptListTile"  *  * @author Tomas Muller  */
end_comment
