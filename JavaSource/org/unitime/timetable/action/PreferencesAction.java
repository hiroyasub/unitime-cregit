...
expr_stmt|;
comment|// Itypes
comment|//LookupTables.setupTimePatterns(request); // Time Patterns
name|LookupTables
operator|.
...
argument_list|,
literal|"Invalid room room group: Check for duplicate / blank selection. "
argument_list|)
argument_list|)
expr_stmt|;
name|saveErrors
...
block|}
block|}
comment|// Distribution Prefs not updated as it is done on a global level
...
expr_stmt|;
block|}
comment|// Distribution Prefs - displayed at the subclass level
if|if
condition|(
name|addBlankRows
condition|)
