...
name|location
operator|=
literal|"instructorDetail.tiles"
argument_list|)
block|,
annotation|@
name|Result
...
name|value
operator|=
literal|"/user/instructorDetail.jsp"
argument_list|)
block|,
annotation|@
name|TilesPutAttribute
...
name|op
argument_list|)
comment|//                || MSG.actionDisplayInstructorPreferences().equals(op)
operator|||
name|MSG
operator|.
...
comment|//super.generateTimePatternGrids(request, form, inst, timePatterns, "init", timeVertical, false, null);
for|for
control|(
name|Preference
name|pref
