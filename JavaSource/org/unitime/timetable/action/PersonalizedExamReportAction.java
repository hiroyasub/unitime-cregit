...
name|info
argument_list|(
literal|"User not logged in, forwarding back."
argument_list|)
expr_stmt|;
name|request
operator|.
...
argument_list|()
operator|+
literal|" has no external id, forwarding to main page."
argument_list|)
expr_stmt|;
name|request
operator|.
...
name|error
argument_list|(
literal|"Unable to generate PDF for "
operator|+
operator|(
name|instructor
operator|!=
...
name|info
argument_list|(
literal|"  Generating calendar for "
operator|+
operator|(
name|instructor
operator|!=
...
name|error
argument_list|(
literal|"Unable to generate calendar for "
operator|+
operator|(
name|instructor
operator|!=
...
name|addLine
argument_list|(
literal|"onClick=\"document.location='personalSchedule.do?session="
operator|+
name|session
operator|.
name|getUniqueId
...
argument_list|)
argument_list|,
literal|"personalSchedule.do?o1=%%&uid="
operator|+
name|student
operator|.
...
argument_list|)
argument_list|,
literal|"personalSchedule.do?o3=%%&uid="
operator|+
name|student
operator|.
name|getExternalUniqueId
...
argument_list|)
argument_list|,
literal|"personalSchedule.do?o2=%%&uid="
operator|+
name|instructor
operator|.
name|getExternalUniqueId
...
argument_list|)
argument_list|,
literal|"personalSchedule.do?o4=%%&uid="
operator|+
name|instructor
operator|.
name|getExternalUniqueId
...
argument_list|)
argument_list|,
literal|"personalSchedule.do?o5=%%&uid="
operator|+
name|instructor
operator|.
name|getExternalUniqueId
...
argument_list|)
argument_list|,
literal|"personalSchedule.do?o6=%%&uid="
operator|+
name|student
operator|.
name|getExternalUniqueId
...
argument_list|)
argument_list|,
literal|"personalSchedule.do?o7=%%&uid="
operator|+
name|instructor
operator|.
name|getExternalUniqueId
