...
name|getMessage
argument_list|(
literal|"button.editPrefsSubpart"
argument_list|)
argument_list|)
operator|||
name|op
...
name|getMessage
argument_list|(
literal|"button.clearAllClassPrefs"
argument_list|)
argument_list|)
condition|)
block|{
...
condition|)
block|{
comment|/*doCancel(request, subpartId); 	            return mapping.findForward("instructionalOfferingSearch"); 	            */
name|response
operator|.
name|sendRedirect
argument_list|(
