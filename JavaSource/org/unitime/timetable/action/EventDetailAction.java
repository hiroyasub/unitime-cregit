...
argument_list|)
decl_stmt|;
comment|//sessionContext.checkPermissionAnyAuthority(event, Right.EventDetail);
if|if
condition|(
name|iOp
operator|!=
...
argument_list|,
literal|"Insufficient rights to approve "
operator|+
name|approvedMeeting
operator|.
name|toString
argument_list|()
operator|+
literal|" (controlling department does not match)."
argument_list|)
argument_list|)
expr_stmt|;
continue|continue;
...
literal|"errors.generic"
argument_list|,
literal|"Insufficient rights to reject "
operator|+
name|rejectedMeeting
operator|.
name|toString
