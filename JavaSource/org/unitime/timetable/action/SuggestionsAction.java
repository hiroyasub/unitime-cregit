...
argument_list|()
operator|+
literal|"&op=Remove'><img src='images/Delete16.gif' border='0'></a>&nbsp;"
expr_stmt|;
name|String
name|line
index|[]
...
name|append
argument_list|(
literal|"<TR><TD colspan='2'><I>Not assigned.</I></TD></TR>"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|append
argument_list|(
literal|"<TR><TD>Instructor:</TD><TD>"
operator|+
name|ca
operator|.
...
name|append
argument_list|(
literal|"<TR><TD>Initial&nbsp;Assignment:</TD><TD>"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|append
argument_list|(
literal|"<TR><TD>Violated&nbsp;Constraints:</TD><TD>"
argument_list|)
expr_stmt|;
for|for
control|(
...
name|append
argument_list|(
literal|"<TR><TD>Room&nbsp;Locations:</TD><TD>"
operator|+
name|ca
operator|.
name|getRooms
...
name|append
argument_list|(
literal|"<TR><TD>Time&nbsp;Locations:</TD><TD>"
operator|+
name|ca
operator|.
name|getTimes
...
operator|)
operator|+
literal|"><TD>Date&nbsp;Patterns:</TD><TD>"
operator|+
name|ca
operator|.
name|getTimes
...
name|append
argument_list|(
literal|"<TR><TD>Minimal Room Size:</TD><TD>"
operator|+
name|ca
operator|.
name|getClazz
...
argument_list|,
literal|"suggestions.do?conf_ord=%%"
argument_list|,
operator|new
name|String
index|[]
