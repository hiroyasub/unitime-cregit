...
begin_comment
comment|/**   * MyEclipse Struts  * Creation date: 09-01-2006  *   * XDoclet definition:  * @struts:action path="/academicAreaReservationEdit" name="academicAreaReservationEditForm" input="/user/academicAreaReservationEdit.jsp" scope="request"  */
end_comment

begin_class
specifier|public
class|class
name|AcademicAreaReservationEditAction
extends|extends
...
comment|//if ( op.equals(rsc.getMessage("button.reservationNextStep")) ) {
comment|//TODO Reservations - functionality to be removed later
if|if
condition|(
name|op
...
name|findForward
argument_list|(
literal|"displayAcadAreaReservationDetail"
argument_list|)
return|;
block|}
