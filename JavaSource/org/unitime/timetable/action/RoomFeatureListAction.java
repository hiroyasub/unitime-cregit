...
begin_comment
comment|/**  * MyEclipse Struts Creation date: 02-18-2005  *   * XDoclet definition:  *   * @struts:action path="/roomFeatureList" name="roomFeatureListForm"  *                input="/admin/roomFeatureList.jsp" scope="request"  *                validate="true"  *  * @author Tomas Muller  */
end_comment
