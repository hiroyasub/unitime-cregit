...
name|append
argument_list|(
literal|"  order by c.uniqueId asc"
argument_list|)
expr_stmt|;
name|q
operator|=
...
name|Exception
argument_list|(
literal|"Creation of such constraint denied: no owner specified."
argument_list|)
throw|;
if|if
condition|(
...
name|Exception
argument_list|(
literal|"Creation of such constraint denied: distribution preference "
operator|+
name|dp
operator|.
name|getDistributionType
...
name|Exception
argument_list|(
literal|"Creation of such constraint denied: unable to create constraint owned by "
operator|+
name|dp
operator|.
name|getOwner
...
name|Exception
argument_list|(
literal|"Creation of such constraint denied: unable to create "
operator|+
name|dp
operator|.
name|getPrefLevel
