...
argument_list|)
expr_stmt|;
comment|//if (c.getSchedulingSubpart().getTeachingLoad() != null)
comment|//	updateInstructorCoursePreferences(hibSession, frm, c, c.getSchedulingSubpart().getControllingCourseOffering());
name|hibSession
operator|.
name|saveOrUpdate
argument_list|(
