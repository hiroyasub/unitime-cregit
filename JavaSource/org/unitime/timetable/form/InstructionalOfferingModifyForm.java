...
specifier|private
name|String
name|displayAllClassesInSchedBook
decl_stmt|;
specifier|private
name|String
...
specifier|private
name|List
name|displayAllClassesInSchedBookForSubpart
decl_stmt|;
specifier|private
name|List
...
specifier|static
name|String
name|DISPLAY_IN_SCHEDULE_BOOKS_TOKEN
init|=
literal|"displayInScheduleBooks"
decl_stmt|;
specifier|private
specifier|static
name|String
...
literal|"errors.required"
argument_list|,
literal|"Instructional Offering Config"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|ActionMessage
argument_list|(
literal|"errors.class.mustHaveChildClasses"
argument_list|,
operator|(
name|String
operator|)
...
name|ActionMessage
argument_list|(
literal|"errors.subpart.mustHaveClass"
argument_list|)
argument_list|)
expr_stmt|;
break|break;
...
name|ActionMessage
argument_list|(
literal|"errors.limit.minGreaterThanMaxLimit"
argument_list|,
operator|(
name|String
operator|)
...
operator|)
condition|?
literal|"errors.maxLimit.childClasses"
else|:
literal|"errors.limit.childClasses"
operator|)
argument_list|)
expr_stmt|;
name|validateSubpartClassLimits
...
condition|)
block|{
name|setDisplayAllClassesInSchedBook
argument_list|(
literal|"false"
argument_list|)
expr_stmt|;
...
name|this
operator|.
name|setDisplayAllClassesInSchedBookForSubpart
argument_list|(
name|DynamicList
operator|.
name|getInstance
...
argument_list|)
expr_stmt|;
name|getDisplayAllClassesInSchedBookForSubpart
argument_list|()
operator|.
name|add
argument_list|(
...
decl_stmt|;
name|boolean
name|canRemoveFromDisplayInScheduleBooks
decl_stmt|;
name|boolean
...
specifier|public
name|void
name|setDisplayInScheduleBooks
parameter_list|(
name|List
name|displayInScheduleBooks
parameter_list|)
...
specifier|public
name|String
name|getDisplayAllClassesInSchedBook
parameter_list|()
block|{
return|return
name|displayAllClassesInSchedBook
...
specifier|public
name|Boolean
name|getDisplayDisplayInSchedule
parameter_list|()
block|{
return|return
name|displayDisplayInSchedule
...
specifier|public
name|void
name|setDisplayDisplayInSchedule
parameter_list|(
name|Boolean
name|displayDisplayInSchedule
parameter_list|)
