...
specifier|private
name|String
name|iMainContactExternalId
decl_stmt|;
specifier|private
name|boolean
name|iMainContactLookup
decl_stmt|;
specifier|private
name|String
name|iEventType
...
literal|"errors.generic"
argument_list|,
literal|"The event name cannot exceed 100 characters."
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
literal|"errors.generic"
argument_list|,
literal|"The contact's email cannot exceed 200 characters."
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
literal|"errors.generic"
argument_list|,
literal|"The contact's last name is mandatory."
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
literal|"errors.generic"
argument_list|,
literal|"The contact's phone cannot exceed 25 characters."
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
literal|"errors.generic"
argument_list|,
literal|"Invalid data in event main contact phone"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/* else if (iEventName==null) { 			if (tm!=null) { 					iMainContactFirstName = (tm.getFirstName()==null?"":tm.getFirstName()); 					iMainContactLastName = (tm.getLastName()==null?"":tm.getLastName()); 					iMainContactEmail = (tm.getEmailAddress()==null?"":tm.getEmailAddress()); 			} 		}*/
name|loadNewMeetings
argument_list|()
expr_stmt|;
block|}
specifier|public
