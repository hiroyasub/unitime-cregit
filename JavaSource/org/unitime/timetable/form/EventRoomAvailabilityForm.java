...
literal|"' "
operator|+
comment|//"onClick=\"tClick('"+df2.format(date)+"','"+location.getPermanentId()+"');\" "+
comment|//"onMouseOver=\"tOver(this,'"+df2.format(date)+"','"+location.getPermanentId()+"');\" "+
comment|//"onMouseOut=\"tOut('"+df2.format(date)+"','"+location.getPermanentId()+"');\" "+
literal|">"
expr_stmt|;
name|int
name|idx
