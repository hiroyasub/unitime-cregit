...
specifier|public
name|Collection
name|getControlCourseOfferings
parameter_list|()
block|{
return|return
name|controlCourseOfferings
return|;
block|}
comment|/** 	 * @param controlCourseOfferings 	 *            The controlCourseOfferings to set. 	 */
specifier|public
name|void
name|setControlCourseOfferings
parameter_list|(
name|Collection
name|controlCourseOfferings
parameter_list|)
