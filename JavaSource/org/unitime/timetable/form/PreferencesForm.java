...
expr_stmt|;
block|}
comment|/**      * Checks that there are no duplicates and that all prior prefs have a value      * @param lst List<String> of values      * @return true if checks ok, false otherwise      */
specifier|public
name|boolean
name|checkPrefs
parameter_list|(
...
return|;
block|}
comment|/**      * Checks that pref levels are selected      * @param lst List<String> of pref levels      * @return true if checks ok, false otherwise      */
specifier|public
name|boolean
name|checkPrefLevels
parameter_list|(
