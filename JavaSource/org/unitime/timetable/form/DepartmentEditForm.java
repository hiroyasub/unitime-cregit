...
expr_stmt|;
block|}
comment|/** 	 * Test to see if the department can be deleted. 	 * All of its InstructionalOfferings must be not offered. 	 * @param department 	 */
specifier|private
name|boolean
name|deptHasOfferedCourses
parameter_list|(
name|Department
name|department
parameter_list|)
...
if|if
condition|(
name|subjectAreaHasOfferedCourses
argument_list|(
name|department
argument_list|,
name|subject
...
return|;
block|}
comment|/** 	 * Test whether any InstructionalOfferings for the SubjectArea are offered.  	 * @param department 	 * @param subject 	 */
specifier|private
name|boolean
name|subjectAreaHasOfferedCourses
parameter_list|(
...
return|;
block|}
comment|/** 	 * If the InstructionalOffering has multiple CourseOfferings, check to see 	 *  that all the CourseOfferings' SubjectAreas are owned by the Department 	 *  to be deleted. 	 * @param department 	 * @param instrOffer 	 */
specifier|private
name|void
name|checkCourseOfferings
parameter_list|(
