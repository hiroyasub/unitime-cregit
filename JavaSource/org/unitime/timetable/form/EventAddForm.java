...
literal|"errors.generic"
argument_list|,
literal|"Invalid data in event name"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
literal|"errors.generic"
argument_list|,
literal|"Building is not selected (it is needed for close by locations)."
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|disblePast
condition|?
literal|"Past / Outside Session"
else|:
literal|"Outside Session"
operator|)
operator|+
literal|"'],"
operator|+
...
name|NonUniversityLocation
argument_list|>
name|getNonUniversityLocations
parameter_list|(
name|long
name|roomType
parameter_list|)
...
name|query
operator|+=
literal|" and r.building.uniqueId=:buildingId"
expr_stmt|;
block|}
block|}
if|if
