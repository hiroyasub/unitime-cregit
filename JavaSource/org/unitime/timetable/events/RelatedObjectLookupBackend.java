...
name|createQuery
argument_list|(
literal|"select distinct co.subjectArea from ClassInstructor ci inner join ci.classInstructing.schedulingSubpart.instrOfferingConfig.instructionalOffering.courseOfferings co "
operator|+
literal|"where co.subjectArea.session.uniqueId = :sessionId and ci.instructor.externalUniqueId = :externalId"
argument_list|)
operator|.
name|setLong
argument_list|(
...
name|createQuery
argument_list|(
literal|"select distinct co from ClassInstructor ci inner join ci.classInstructing.schedulingSubpart.instrOfferingConfig.instructionalOffering.courseOfferings co "
operator|+
literal|"where co.subjectArea.uniqueId = :subjectAreaId and ci.instructor.externalUniqueId = :externalId"
argument_list|)
operator|.
name|setLong
argument_list|(
...
name|createQuery
argument_list|(
literal|"select distinct ci.classInstructing from ClassInstructor ci inner join ci.classInstructing.schedulingSubpart.instrOfferingConfig.instructionalOffering.courseOfferings co "
operator|+
literal|"where co.uniqueId = :courseId and ci.instructor.externalUniqueId = :externalId"
argument_list|)
operator|.
name|setLong
argument_list|(
...
name|createQuery
argument_list|(
literal|"select distinct ci.classInstructing.schedulingSubpart from ClassInstructor ci inner join ci.classInstructing.schedulingSubpart.instrOfferingConfig.instructionalOffering.courseOfferings co "
operator|+
literal|"where co.uniqueId = :courseId and ci.instructor.externalUniqueId = :externalId"
argument_list|)
operator|.
...
name|createQuery
argument_list|(
literal|"select c from Class_ c where c.schedulingSubpart.uniqueId = :subpartId"
argument_list|)
operator|.
name|setLong
argument_list|(
...
literal|"select distinct ci.classInstructing from ClassInstructor ci inner join ci.classInstructing.schedulingSubpart.instrOfferingConfig.instructionalOffering.courseOfferings co "
operator|+
literal|"where ci.classInstructing.schedulingSubpart.uniqueId = :subpartId and ci.instructor.externalUniqueId = :externalId"
argument_list|)
operator|.
name|setLong
argument_list|(
