...
name|where
argument_list|(
literal|"bit_and(s.statusType.status, :flag)> 0"
argument_list|)
operator|.
name|set
argument_list|(
...
name|where
argument_list|(
literal|"(bit_and(s.statusType.status, :final)> 0 and e.class = 'FinalExamEvent') or (bit_and(s.statusType.status, :midterm)> 0 and e.class = 'MidtermExamEvent')"
argument_list|)
operator|.
name|set
argument_list|(
