...
argument_list|)
expr_stmt|;
comment|// contact.setExternalId(m.getEvent().getMainContact().getExternalUniqueId());
comment|// contact.setPhone(m.getEvent().getMainContact().getPhone());
comment|// contact.setEmail(m.getEvent().getMainContact().getEmailAddress());
name|event
operator|.
name|setContact
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// instructor.setExternalId(i.getInstructor().getExternalUniqueId());
comment|// instructor.setEmail(i.getInstructor().getEmail());
name|event
operator|.
name|addInstructor
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// instructor.setExternalId(i.getExternalUniqueId());
comment|// instructor.setEmail(i.getEmail());
name|event
operator|.
name|addInstructor
argument_list|(
