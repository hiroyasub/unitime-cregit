...
argument_list|()
operator|+
literal|" cannot be created through the event interface."
argument_list|)
throw|;
block|}
block|}
...
argument_list|()
operator|+
literal|" is not managed in UniTime."
argument_list|)
throw|;
name|boolean
name|managed
...
argument_list|()
operator|+
literal|" is disabled for events"
operator|+
operator|(
name|opt
operator|!=
...
block|{
comment|//if (!Roles.ADMIN_ROLE.equals(helper.getUser().getRole())) {
for|for
control|(
name|MeetingInterface
name|x
