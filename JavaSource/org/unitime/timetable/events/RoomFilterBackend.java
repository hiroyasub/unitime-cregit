...
name|eventRooms
condition|?
literal|" and l.eventDepartment.allowEvents = true and ((l.eventStatus is null and o.status != 0 and o.roomType = l.roomType and o.department = l.eventDepartment) or l.eventStatus != 0)"
else|:
literal|""
operator|)
argument_list|)
