...
literal|"mode"
argument_list|,
literal|"m.approvedDate is null and Xl.session.uniqueId = :sessionId and Xl.permanentId = m.locationPermanentId and Xrd.control=true and Xg.externalUniqueId = :Xuser"
argument_list|)
expr_stmt|;
name|query
operator|.
