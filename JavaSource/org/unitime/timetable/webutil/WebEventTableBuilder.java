...
expr_stmt|;
block|}
comment|//    	this.endCell(cell, true);
return|return
operator|(
name|cell
operator|)
...
name|addContent
argument_list|(
literal|"Warning: There are more than "
operator|+
name|getMaxResults
argument_list|()
operator|+
literal|" events matching your search criteria. Only the first "
operator|+
name|getMaxResults
argument_list|()
operator|+
...
argument_list|()
operator|+
literal|" meetings matching your search criteria. Only the first "
operator|+
name|getMaxResults
argument_list|()
operator|+
