...
name|append
argument_list|(
literal|"var x = document.getElementsByName('c"
operator|+
name|cell
operator|.
name|getAssignmentId
argument_list|()
operator|+
literal|"'); for (var i = 0; i< x.length; i++) x[i].style.backgroundColor='rgb(223,231,242)';"
argument_list|)
expr_stmt|;
name|onMouseOut
operator|.
...
argument_list|()
operator|+
literal|"'); for (var i = 0; i< x.length; i++) x[i].style.backgroundColor='"
operator|+
operator|(
name|bgColor
operator|==
