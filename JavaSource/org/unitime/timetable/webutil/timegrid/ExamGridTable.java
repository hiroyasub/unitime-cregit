...
name|println
argument_list|(
literal|"<th nowrap class='Timetable"
operator|+
operator|(
name|rowNumber
operator|==
...
name|println
argument_list|(
literal|"<th nowrap width='130' height='40' class='TimetableHeadCellVertical"
operator|+
operator|(
name|eol
condition|?
...
name|println
argument_list|(
literal|"<th nowrap width='130' height='40' class='Timetable"
operator|+
operator|(
name|rowNumber
operator|==
...
block|{
return|return
literal|"window.open('examDetail.do?examId="
operator|+
name|getInfo
argument_list|()
operator|.
