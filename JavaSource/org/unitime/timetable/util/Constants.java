...
parameter_list|)
block|{
comment|// webSession.setAttribute(Constants.SUBJ_AREA_ID_ATTR_NAME, null);
comment|// webSession.setAttribute(Constants.CRS_NBR_ATTR_NAME, null);
name|webSession
operator|.
name|setAttribute
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// webSession.removeAttribute(Constants.CRS_ASGN_LST_SUBJ_AREA_IDS_ATTR_NAME);
name|webSession
operator|.
