...
argument_list|)
decl_stmt|,
comment|/** 	 * Custom login page header, see https://help.unitime.org/customizations for more details.  	 */
decl_stmt|@
name|Description
argument_list|(
...
argument_list|)
decl_stmt|,
comment|/** 	 * Custom login page footer, see https://help.unitime.org/customizations for more details.  	 */
decl_stmt|@
name|Description
argument_list|(
...
argument_list|)
decl_stmt|,
comment|/** 	 * Default application menu style. Values:<ul> 	 *<li>Static On Top ... Horizontal menu bar on the top of the page (takes 100% width of the page, does not move with the page) 	 *<li>Dynamic On Top ... Horizontal menu bar on the top of the page (takes 100% width of the client window, moves with the page as it is scrolled) 	 *<li>Tree On Side ... Tree on the left side of the page content (moves with the page, resembles the UniTime 3.1 menu the most) 	 *<li>Stack On Side ... Tree on the left side of the page content, but the first level of the tree is a StackPanel (only one top level item can be opened at a time) 	 *</ul> 	 * If manager setting for this property is created, each user (timetable manager) can change his/her menu style. 	 * See https://help.unitime.org/customizations for more details. 	 */
decl_stmt|@
name|DefaultValue
argument_list|(
...
argument_list|)
decl_stmt|,
comment|/** 	 * LDAP Authentication. See https://help.unitime.org/LDAP for more details. 	 */
decl_stmt|@
name|Description
argument_list|(
...
name|DefaultValue
argument_list|(
literal|"https://help47.unitime.org/"
argument_list|)
expr|@
name|Description
argument_list|(
...
name|Description
argument_list|(
literal|"Course Offerings: search for a match in course title too"
argument_list|)
name|CourseOfferingTitleSearch
argument_list|(
literal|"tmtbl.courseNumber.searchTitle"
argument_list|)
operator|,
expr_stmt|@
name|DefaultValue
...
name|Description
argument_list|(
literal|"Online Student Scheduling: enable student email confirmations when wait-list enrollment fails"
argument_list|)
name|OnlineSchedulingEmailConfirmationWhenFailed
argument_list|(
literal|"unitime.enrollment.email.failedWaitList"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Online Student Scheduling: enable student email confirmations from a particular operation %"
argument_list|)
...
argument_list|)
operator|,
comment|/** 	 * Room availability. By default, use the included event management system. 	 * See https://help.unitime.org/custom-room-availability for more details. 	 */
expr_stmt|@
name|Type
argument_list|(
name|Class
...
argument_list|)
operator|,
comment|/** 	 * Use {@link SpringLdapExternalUidLookup} when LDAP authentication is enabled. 	 * See https://help.unitime.org/LDAP for more details. 	 */
expr_stmt|@
name|Type
argument_list|(
name|Class
...
name|Description
argument_list|(
literal|"ExternalSectionMonitoredUpdateMessage interface called when the update to the external system needs to be monitored for success or failure."
argument_list|)
name|ExternalActionSectionMonitoredUpdateMessage
argument_list|(
literal|"unitime.external.section_monitored_update_message.class"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"ExternalVariableTitleDataLookup interface called when a view exists to the external system that provides additional information about variable title courses."
argument_list|)
name|ExternalVariableTitleDataLookup
argument_list|(
...
argument_list|)
operator|,
comment|/** 	 * Use {@link SpringLdapExternalUidTranslation} when LDAP authentication is enabled. 	 * See https://help.unitime.org/LDAP for more details. 	 */
expr_stmt|@
name|Type
argument_list|(
name|Class
...
argument_list|)
operator|,
comment|/** 	 * See https://help.unitime.org/exam-naming-convention for more details. 	 */
expr_stmt|@
name|Type
argument_list|(
name|Integer
...
name|Description
argument_list|(
literal|"Customization: advisor course requests validation provider (interface AdvisorCourseRequestsValidationProvider, used by Advisor Course Recommendations when the entered data are being validated)"
argument_list|)
name|CustomizationAdvisorsCourseRequestsValidation
argument_list|(
literal|"unitime.custom.AdvisorCourseRequestsValidationProvider"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Customization: student special registration dashboard URL provider (interface SpecialRegistrationDashboardUrlProvider, used by Online Student Scheduling Dasbhard to provide link to the special registration dashboard)"
argument_list|)
expr|@
name|Since
argument_list|(
...
argument_list|(
literal|"unitime.custom.SpecialRegistrationDashboardUrlProvider"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Customization: variable title course provider"
argument_list|)
expr|@
name|Since
argument_list|(
...
name|Description
argument_list|(
literal|"Customization: wait-list compatator provider"
argument_list|)
expr|@
name|DefaultValue
argument_list|(
literal|"org.unitime.timetable.onlinesectioning.custom.DefaultSectioningRequestComparatorProvider"
argument_list|)
expr|@
name|Since
argument_list|(
...
argument_list|(
literal|"unitime.custom.WaitListComparatorProvider"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"PDF Font: font size used in Examination PDF Reports (New)"
argument_list|)
name|PdfFontSizeExams
argument_list|(
literal|"unitime.pdf.fontsize.exams"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|DefaultValue
argument_list|(
literal|"https://help.unitime.org/frequently-asked-questions"
argument_list|)
expr|@
name|Description
argument_list|(
...
name|DefaultValue
argument_list|(
literal|"https://help.unitime.org/timetabling"
argument_list|)
expr|@
name|Description
argument_list|(
...
name|DefaultValue
argument_list|(
literal|"https://help.unitime.org/tips-and-tricks"
argument_list|)
expr|@
name|Description
argument_list|(
...
name|Description
argument_list|(
literal|"Online Student Scheduling: enable student scheduling preferences"
argument_list|)
expr|@
name|Since
argument_list|(
literal|4.6
argument_list|)
name|OnlineSchedulingStudentPreferencesEnabled
argument_list|(
literal|"unitime.enrollment.studentPrefs.enabled"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Online Student Scheduling Preferences: allow selection of start and end dates (typically only enabled for Summer term)"
argument_list|)
expr|@
name|Since
argument_list|(
...
argument_list|(
literal|"unitime.enrollment.studentPrefs.datesAllowed"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Online Student Scheduling Preferences: custom note to be shown on the dialog (may contain HTML elements)"
argument_list|)
expr|@
name|Since
argument_list|(
...
argument_list|(
literal|"unitime.enrollment.studentPrefs.customNote"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Online Student Scheduling Preferences: allow require online (typically only enabled for Summer term)"
argument_list|)
expr|@
name|Since
argument_list|(
...
argument_list|(
literal|"unitime.enrollment.studentPrefs.reqOnlineAllowed"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Course Finder: when subject area starts with the student's campus code, move courses that match student's primary campus to the top of the list"
argument_list|)
name|ListCourseOfferingsMatchingCampusFirst
argument_list|(
literal|"unitime.enrollment.listOfferings.campusFirst"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Advisor Course Recommendations: default advisor note"
argument_list|)
expr|@
name|Since
argument_list|(
literal|4.5
argument_list|)
name|AdvisorCourseRequestsDefaultNote
argument_list|(
literal|"unitime.acrf.note"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|DefaultValue
argument_list|(
literal|"org.unitime.timetable.util.DefaultAcademicSessionLookup"
argument_list|)
expr|@
name|Description
argument_list|(
literal|"Academic Session Lookup: implementation class (implementing AcademicSessionLookup interface)"
argument_list|)
name|AcademicSessionLookupImplementation
argument_list|(
literal|"unitime.session.lookup.class"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Variable Title: Course Configuration Name"
argument_list|)
expr|@
name|Since
argument_list|(
...
argument_list|(
literal|"unitime.variableTitle.configName"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Variable Title: Instructional Type - This should match the reference of the instructional type."
argument_list|)
expr|@
name|Since
argument_list|(
...
argument_list|(
literal|"unitime.variableTitle.instructionalType"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Variable Title: Default Generated Date Pattern Prefix"
argument_list|)
expr|@
name|Since
argument_list|(
...
argument_list|(
literal|"unitime.variableTitle.datePatternPrefix"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Variable Title: Default Consent Type - This should match the reference of the consent type.  If no abbreviation is given, no consent type will be set."
argument_list|)
expr|@
name|Since
argument_list|(
...
argument_list|(
literal|"unitime.variableTitle.defaultConsentType"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Variable Title: Default Course Credit Type - This should match the reference of the course credit type."
argument_list|)
expr|@
name|Since
argument_list|(
...
argument_list|(
literal|"unitime.variableTitle.defaultCourseCreditType"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|DefaultValue
argument_list|(
literal|"semesterHours"
argument_list|)
expr|@
name|Description
argument_list|(
literal|"Variable Title: Default Course Credit Unit Type - This should match the reference of the course credit unit type.  If no abbreviation is given, no consent type will be set."
argument_list|)
expr|@
name|Since
argument_list|(
...
argument_list|(
literal|"unitime.variableTitle.defaultCourseCreditUnitType"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Variable Title: Default Limit (-1 means unlimited enrollment).  This will be used for all generated Instructional Offering Configurations and Classes.  The user can edit this value after the configuration/class has been created."
argument_list|)
name|VariableTitleDefaultLimit
argument_list|(
literal|"unitime.variableTitle.defaultLimit"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Variable Title: Default starting character(s) for the generated course suffix."
argument_list|)
name|VariableTitleCourseSuffixDefaultStartCharacter
argument_list|(
literal|"unitime.variableTitle.courseSuffixDefaultStartCharacter"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Variable Title: Wait time for external system section creation validation in seconds.  If wait time is exeeded, PENDING will be returned as the external system creation status."
argument_list|)
name|VariableTitleExternalSystemWaitTime
argument_list|(
literal|"unitime.variableTitle.defaultExternalSystemWaitTime"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Variable Title: Instructor Id is Required"
argument_list|)
name|VariableTitleInstructorIdRequired
argument_list|(
literal|"unitime.variableTitle.instructorIdRequired"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Variable Title: When set to true, the first character of each word in the title will be made upper case all other characters will be left as is."
argument_list|)
expr|@
name|Since
argument_list|(
literal|4.5
argument_list|)
name|VariableTitleTitleFirstCharsOfWordsUpperCase
argument_list|(
literal|"unitime.variableTitle.title.firstUpperCase"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Course Timetabling Solution Commit: Skip checking for room and instructor conflicts with other committed problems."
argument_list|)
expr|@
name|Since
argument_list|(
...
name|Description
argument_list|(
literal|"Instructional Offerings: show wait-list filter"
argument_list|)
expr|@
name|Since
argument_list|(
...
argument_list|(
literal|"unitime.offering.waitListFilter"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Instructional Offering Configuration: allow instructional method to be changed on a wait-listed course when there are students enrolled"
argument_list|)
expr|@
name|Since
argument_list|(
...
argument_list|(
literal|"unitime.offering.waitList.canChangeInstructionalMethod"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Edit Subpart / Class: allow date pattern to be changed on a wait-listed course when there are students enrolled"
argument_list|)
expr|@
name|Since
argument_list|(
...
argument_list|(
literal|"unitime.offering.waitList.canChangeDatePattern"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Course Assign Instructors: switch the user interface back to the old (Struts-based) assign instructor page"
argument_list|)
...
name|Description
argument_list|(
literal|"Departments: switch the user interface back to the old (Struts-based) departments pages"
argument_list|)
name|LegacyDepartments
argument_list|(
literal|"unitime.legacy.admin.departments"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Departments: switch the user interface back to the old (Struts-based) subject areas pages"
argument_list|)
name|LegacySubjectAreas
argument_list|(
...
name|Description
argument_list|(
literal|"Scheduling Assistant: show Degree Plan button on the Scheduling Assistant or Course Requests pages (when custom DegreePlansProvider is configured)"
argument_list|)
name|DegreePlanForStudents
argument_list|(
literal|"unitime.degreePlan.students"
argument_list|)
operator|,
expr_stmt|@
name|Type
...
name|Description
argument_list|(
literal|"Course Recommendations: show Degree Plan button on the Advisor Course Recommendations page (when custom DegreePlansProvider is configured)"
argument_list|)
name|DegreePlanForAdvisors
argument_list|(
literal|"unitime.degreePlan.advisors"
argument_list|)
operator|,
expr_stmt|;
end_expr_stmt
