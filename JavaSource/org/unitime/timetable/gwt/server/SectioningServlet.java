...
name|createQuery
argument_list|(
literal|"from StudentClassEnrollment e where e.student.uniqueId = :studentId"
argument_list|)
operator|.
name|setLong
argument_list|(
...
name|createQuery
argument_list|(
literal|"from CourseDemand d where d.student.uniqueId = :studentId"
argument_list|)
operator|.
name|setLong
argument_list|(
