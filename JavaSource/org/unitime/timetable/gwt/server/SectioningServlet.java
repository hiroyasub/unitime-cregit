...
argument_list|()
operator|+
literal|" guessed from student id "
operator|+
name|student
operator|.
name|getExternalUniqueId
...
argument_list|()
operator|+
literal|" guessed from session id "
operator|+
name|cx
operator|.
name|getSessionId
...
name|properties
operator|.
name|setEmailOptionalToggleCaption
argument_list|(
name|email
operator|.
...
name|properties
operator|.
name|setEmailOptionalToggleDefault
argument_list|(
name|email
operator|.
...
name|createQuery
argument_list|(
literal|"select replace(acr.notes, acr.student.pin, '$PIN$'), count(acr), max(acr.timestamp) "
operator|+
literal|"from AdvisorCourseRequest acr where acr.priority = -1 and acr.changedBy = :externalId and acr.student.session = :sessionId "
operator|+
literal|"group by replace(acr.notes, acr.student.pin, '$PIN$') "
operator|+
literal|"order by max(acr.timestamp) desc"
argument_list|)
operator|.
name|setString
argument_list|(
...
name|SectioningException
argument_list|(
literal|"Failed to load log message: Log message has no details."
argument_list|)
throw|;
block|}
block|}
...
name|SectioningException
argument_list|(
literal|"Failed to parse log message: "
operator|+
name|e
operator|.
name|getMessage
...
name|SectioningException
argument_list|(
literal|"Failed to load log message: Log message does not exist."
argument_list|)
throw|;
block|}
block|}
...
name|createQuery
argument_list|(
literal|"select uniqueId, action from OnlineSectioningLog where uniqueId in :logIds"
argument_list|)
operator|.
