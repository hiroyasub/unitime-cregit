...
name|CurriculaException
argument_list|(
literal|"You are not authorized to "
operator|+
operator|(
name|c
operator|.
...
name|CurriculaException
argument_list|(
literal|"You are not authorized to delete this curriculum."
argument_list|)
throw|;
name|ChangeLog
operator|.
...
name|CurriculaException
argument_list|(
literal|"You are not authorized to delete curriculum "
operator|+
name|c
operator|.
name|getAbbv
...
name|CurriculaException
argument_list|(
literal|"You are not authorized to merge curriculum "
operator|+
name|curriculum
operator|.
name|getAbbv
...
name|createQuery
argument_list|(
literal|"select d from Department d where d.session.uniqueId = :sessionId order by d.deptCode"
argument_list|)
operator|.
name|setLong
argument_list|(
...
name|CurriculaException
argument_list|(
literal|"not authorized to see curriculum projection rules"
argument_list|)
throw|;
name|HashMap
argument_list|<
