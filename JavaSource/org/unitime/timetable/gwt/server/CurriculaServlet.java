...
name|createQuery
argument_list|(
literal|"select a.academicClassification.uniqueId, count(distinct s) from CourseRequest r inner join r.courseDemand.student s inner join s.academicAreaClassifications a "
operator|+
operator|(
name|majorIds
operator|.
...
name|createQuery
argument_list|(
literal|"select a.academicClassification.uniqueId, s.uniqueId from CourseRequest r inner join r.courseDemand.student s inner join s.academicAreaClassifications a "
operator|+
operator|(
name|majorIds
operator|.
...
name|createQuery
argument_list|(
literal|"select a.academicClassification.uniqueId, r.courseOffering.uniqueId, count(distinct s) from CourseRequest r inner join r.courseDemand.student s inner join s.academicAreaClassifications a "
operator|+
operator|(
name|majorIds
operator|.
...
operator|)
operator|+
literal|"group by a.academicClassification.uniqueId, r.courseOffering.uniqueId"
argument_list|)
operator|.
name|setLong
argument_list|(
...
name|createQuery
argument_list|(
literal|"select a.academicClassification.uniqueId, r.courseOffering.uniqueId, r.courseOffering.subjectArea.subjectAreaAbbreviation || ' ' || r.courseOffering.courseNbr, s.uniqueId from CourseRequest r inner join r.courseDemand.student s inner join s.academicAreaClassifications a "
operator|+
operator|(
name|majorIds
operator|.
...
name|createQuery
argument_list|(
literal|"select a.academicArea.uniqueId, m.uniqueId, a.academicClassification.uniqueId, count(distinct s) "
operator|+
literal|"from CourseRequest r inner join r.courseDemand.student s inner join s.academicAreaClassifications a inner join s.posMajors m where "
operator|+
literal|"r.courseOffering.uniqueId = :courseId group by a.academicArea.uniqueId, m.uniqueId, a.academicClassification.uniqueId"
argument_list|)
operator|.
name|setLong
argument_list|(
