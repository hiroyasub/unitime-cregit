...
name|createQuery
argument_list|(
literal|"select count(f) from Staff f where f.positionCode.positionType.uniqueId = :uniqueId"
argument_list|)
operator|.
name|setLong
argument_list|(
...
name|createQuery
argument_list|(
literal|"select count(f) from Staff f where f.positionCode.positionCode = :code"
argument_list|)
operator|.
name|setString
argument_list|(
