...
begin_comment
comment|/* import org.unitime.timetable.gwt.command.client.GwtRpcResponseBoolean; import org.unitime.timetable.gwt.command.server.GwtRpcImplements; import org.unitime.timetable.model.ChangeLog; import org.unitime.timetable.model.Curriculum; import org.unitime.timetable.model.Department; import org.unitime.timetable.model.DepartmentStatusType; import org.unitime.timetable.model.TimetableManager; import org.unitime.timetable.util.ReferenceList; */
end_comment
...
argument_list|)
decl_stmt|;
comment|/*  if (cmp!=0) return cmp;         cmp = new NaturalOrderComparator().compare(         		getDeptCode() == null ? "" : getDeptCode(),         		d.getDeptCode() == null ? "" : d.getDeptCode());         if (cmp!=0) return cmp;         cmp = new NaturalOrderComparator().compare(         		getAbbreviation() == null ? "" : getAbbreviation(),         		d.getAbbreviation() == null ? "" : d.getAbbreviation());         if (cmp!=0) return cmp;*/
return|return
operator|(
name|getUniqueId
argument_list|()
...
literal|true
decl_stmt|;
comment|//private boolean iCanExportCsv = false;
specifier|private
name|boolean
name|iCoursesFundingDepartmentsEnabled
init|=
...
name|info
argument_list|(
literal|"DepartmentsDataResponse.isCanExportPDF()"
operator|+
name|iCanExportPdf
argument_list|)
expr_stmt|;
...
block|}
comment|/*  	 * Can delete 	 */
comment|/*public boolean isCanDelete() {  		Logger log = Logger.getLogger(DepartmentInterface.class.getName()); 		log.info("iCanDelete"+iCanDelete.booleanValue()); 		return iCanDelete != null&& iCanDelete.booleanValue(); }*/
