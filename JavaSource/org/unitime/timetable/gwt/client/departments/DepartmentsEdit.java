...
specifier|private
name|FlexTable
name|iCurrentControlDeptFlexTable
decl_stmt|;
specifier|private
name|VerticalPanel
name|iCurrentControlDeptMainPanel
decl_stmt|;
specifier|private
name|TextBox
name|iExternalId
...
name|addStyleName
argument_list|(
literal|"unitime-DepartmentEdit"
argument_list|)
expr_stmt|;
name|iHeader
operator|=
...
argument_list|)
expr_stmt|;
comment|//if(department.getExternalManager().booleanValue() == false){
if|if
condition|(
name|department
operator|.
...
parameter_list|()
block|{
comment|//Logger log = Logger.getLogger(DepartmentsEdit.class.getName());
comment|//log.info("getValue");
name|iDepartment
operator|.
name|setName
argument_list|(
