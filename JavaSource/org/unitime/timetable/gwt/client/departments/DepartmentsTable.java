...
argument_list|)
expr_stmt|;
comment|//resetVisibility();
comment|//setSortBy(AdminCookie.getInstance().getSortDepartmentsBy());
if|if
condition|(
name|iSelectable
condition|)
...
parameter_list|)
block|{
comment|//DecimalFormat df5 = new DecimalFormat("####0");
name|NumberFormat
name|df5
init|=
name|NumberFormat
...
argument_list|)
return|;
comment|//return new Label(department.getLastChangeStr());
default|default:
return|return
literal|null
return|;
...
block|}
block|}
comment|/* 		 * if applicable the sort arrow appears  		 */
specifier|public
specifier|static
name|boolean
name|isApplicable
