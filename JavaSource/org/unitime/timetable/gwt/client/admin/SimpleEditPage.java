...
name|createLookupCallback
parameter_list|()
comment|/*-{ 		return function(person) { 			@org.unitime.timetable.gwt.client.admin.SimpleEditPage::personFound(Ljava/lang/String;Ljava/lang/String;)(person[0], 				person[3] + ", " + person[1] + (person[2] == null ? "" : " " + person[2])); 		}; 	}-*/
function_decl|;
block|}
end_class
