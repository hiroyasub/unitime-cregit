...
name|addStyleName
argument_list|(
literal|"unitime-SolutionChangesPage"
argument_list|)
expr_stmt|;
name|initWidget
argument_list|(
...
name|createTriggers
parameter_list|()
comment|/*-{ 		$wnd.refreshPage = function() { 			@org.unitime.timetable.gwt.client.solver.SolutionChangesPage::__search()(); 		}; 	}-*/
function_decl|;
specifier|public
specifier|static
name|void
...
name|query
init|=
literal|"output=solution-changes."
operator|+
name|format
operator|+
name|iFilter
