...
name|iColumnSection
decl_stmt|,
name|iColumnPublishedTime
decl_stmt|,
name|iColumnAllocatedTime
decl_stmt|,
name|iColumnSetupTime
decl_stmt|,
name|iColumnTeardownTime
decl_stmt|,
name|iColumnMainContact
decl_stmt|,
name|iColumnEnrollment
decl_stmt|,
name|iColumnLimit
decl_stmt|;
specifier|private
...
argument_list|)
expr_stmt|;
comment|// int row = addRow(event, line);
comment|// getRowFormatter().setVerticalAlign(row, HasVerticalAlignment.ALIGN_TOP);
block|}
specifier|public
name|void
name|resetColumnVisibility
