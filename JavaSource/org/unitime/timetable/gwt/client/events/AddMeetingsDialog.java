...
argument_list|()
condition|)
name|populateHorizontal
argument_list|(
name|index
argument_list|)
expr_stmt|;
else|else
name|populateVertical
argument_list|(
name|index
argument_list|)
expr_stmt|;
...
name|message
operator|+=
literal|"<table border='0' class='table'><tr class='row'>"
operator|+
literal|"<td class='header'>"
operator|+
name|MESSAGES
operator|.
name|colName
...
name|addStyleName
argument_list|(
literal|"unitime-IgnoreRoomCheck"
argument_list|)
expr_stmt|;
name|p
operator|.
