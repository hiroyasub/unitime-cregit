...
name|date
parameter_list|)
comment|/*-{ 		try { 			var state = "term=" + term + "&type=" + type.toLowerCase() + "&name=" + name.replace(' ', '+') + (date == null ? "" : "&date=" + date); 			$wnd.history.pushState(state, "", "gwt.jsp?page=" + page + "&" + state); 		} catch (err) { 		} 	}-*/
function_decl|;
block|}
end_class
