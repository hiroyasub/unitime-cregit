...
expr_stmt|;
block|}
comment|/* 					if (iResource.hasCalendar()) { 						iTimeGrid.setCalendarUrl(GWT.getHostPageBaseURL() + "calendar?q=" + iResource.getCalendar()); 						iHeader.setEnabled("export", true); 					} else { 						iHeader.setEnabled("export", false); 					} 					*/
name|iGridPanel
operator|.
name|setWidget
argument_list|(
