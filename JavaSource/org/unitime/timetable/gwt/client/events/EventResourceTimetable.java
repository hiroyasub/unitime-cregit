...
argument_list|)
expr_stmt|;
comment|/* iSession.addAcademicSessionChangeHandler(new AcademicSessionProvider.AcademicSessionChangeHandler() { 			@Override 			public void onAcademicSessionChange(AcademicSessionProvider.AcademicSessionChangeEvent event) { 				sessionChanged(); 			} 		});*/
name|iEvents
operator|=
operator|new
name|EventFilterBox
...
name|events
parameter_list|)
comment|/*-{ 		try { 			var state = "term=" + term + "&type=" + type.toLowerCase() + "&name=" + name.replace(' ', '+') + (date == null ? "" : "&date=" + date) + 				(events == null ? "" : "&events=" + events); 			$wnd.history.pushState(state, "", "gwt.jsp?page=" + page + "&" + state); 		} catch (err) { 		} 	}-*/
function_decl|;
block|}
end_class
