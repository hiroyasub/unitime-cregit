...
name|HTML
argument_list|(
literal|"Filter reservations by any course number, subject area, department, or reservation type."
operator|+
literal|"<br><br>You can also use the following tags:"
operator|+
literal|"<ul>"
operator|+
literal|"<li><i>subject:</i> subject area name or abbreviation"
operator|+
literal|"<li><i>dept:</i> department code, name, or abbreviation"
operator|+
literal|"<li><i>type:</i> reservation type (individual, group, course, curriculum)"
operator|+
literal|"<li><i>student:</i> student name or external id (individual reservations)"
operator|+
literal|"<li><i>group:</i> student group name or abbreviation (student group reservaions)"
operator|+
literal|"<li><i>area:</i> academic area (curriculum reservations)"
operator|+
literal|"<li><i>expiration:</i>,<i>before:</i>,<i>after:</i> expiration date (in MM/dd/yyyy format)"
operator|+
literal|"<li>use<i>expired</i> for expired reservations"
operator|+
literal|"</ul>Use<i>or</i>,<i>and</i>,<i>not</i>, and brackets to build a boolean query."
operator|+
literal|"<br><br>Example: subject:ENGL and (type:individual or type:group) and not expired"
argument_list|,
literal|false
argument_list|)
argument_list|)
