...
argument_list|(
literal|"Validation failed, plaease check the form for warnings."
argument_list|)
expr_stmt|;
block|}
else|else
...
name|createLookupCallback
parameter_list|()
comment|/*-{ 		return function(person) { 			@org.unitime.timetable.gwt.client.reservations.ReservationEdit::personFound(Ljava/lang/String;Ljava/lang/String;)(person[0], 				person[3] + ", " + person[1] + (person[2] == null ? "" : " " + person[2]));     	};  	}-*/
function_decl|;
specifier|public
specifier|static
name|void
