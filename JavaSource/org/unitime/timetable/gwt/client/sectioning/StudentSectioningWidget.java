...
name|iSchedulingPreferencesDialog
init|=
literal|null
decl_stmt|;
specifier|private
...
name|iRequestVariableTitleCourseDialog
init|=
literal|null
decl_stmt|;
specifier|private
...
name|iWaitListedRequestPreferences
init|=
literal|null
decl_stmt|;
specifier|public
...
argument_list|()
expr_stmt|;
name|getWaitListedRequestPreferences
argument_list|()
operator|.
name|setSchedule
argument_list|(
...
parameter_list|()
block|{
name|checkWaitListAfterSubmitSchedule
argument_list|()
expr_stmt|;
block|}
block|}
...
condition|)
block|{
comment|// different assignment proposed -> cannot self wait-list
name|line
operator|.
name|setWaitList
argument_list|(
...
name|unassignedMessage
operator|+=
literal|"<span class='unitime-ErrorText'>"
expr_stmt|;
break|break;
case|case
name|OVERRIDE_PENDING
...
name|unassignedMessage
operator|+=
literal|"<span class='unitime-WarningText'>"
expr_stmt|;
break|break;
case|case
name|OVERRIDE_CANCELLED
...
name|unassignedMessage
operator|+=
literal|"<span class='unitime-GrayText'>"
expr_stmt|;
break|break;
case|case
name|OVERRIDE_APPROVED
...
name|unassignedMessage
operator|+=
literal|"<span class='unitime-GreenText'>"
expr_stmt|;
break|break;
block|}
block|}
...
block|}
block|}
comment|/* 							RequestedCourse rc = iCourseRequests.getRequestedCourse(course.getCourseId()); 							if (rc != null&& rc.hasRequestorNote()) unassignedMessage += "\n<span class='unitime-GrayText'>" + rc.getRequestorNote() + "</span>"; 							if (rc != null&& rc.hasStatusNote()) unassignedMessage += "\n<span class='unitime-GrayText'>" + rc.getStatusNote() + "</span>"; 							*/
block|}
name|waitList
operator|=
operator|new
...
name|String
argument_list|>
name|getCourseChangesWithVarbiableCredit
parameter_list|()
block|{
if|if
condition|(
...
argument_list|(
name|confirmWaitListDrop
argument_list|(
name|confirmEnrollmentHonors
argument_list|(
name|confirmEnrollmentVariableCredits
argument_list|(
name|confirmSectionSwapNoPref
argument_list|(
name|callback
argument_list|)
argument_list|)
...
name|courses
continue|;
comment|// has higher priority course
if|if
condition|(
name|rc
operator|.
