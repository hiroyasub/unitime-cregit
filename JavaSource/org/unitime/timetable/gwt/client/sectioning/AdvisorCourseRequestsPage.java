...
decl_stmt|;
specifier|private
name|AdvisorNotesTable
name|iLastNotesTable
init|=
literal|null
decl_stmt|;
specifier|private
name|ScrollPanel
name|iLastNotesScroll
init|=
literal|null
decl_stmt|;
specifier|private
name|UniTimeDialogBox
name|iLastNotesDialog
init|=
literal|null
decl_stmt|;
specifier|public
...
name|addStyleName
argument_list|(
literal|"waitlist-header-with-critical"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|removeStyleName
argument_list|(
literal|"unitime-PinNotReleased"
argument_list|)
expr_stmt|;
block|}
else|else
...
literal|""
argument_list|,
literal|"toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, "
operator|+
literal|"width=720px, height=400px, top="
operator|+
operator|(
operator|(
name|Window
