...
parameter_list|)
block|{
comment|// Window.open("gwt.jsp?page=sectioning&session=" + iSessionId + "&student=" + event.getData().getStudent().getExternalId(), "_blank", "");
comment|/* 								UniTimeFrameDialog d = new UniTimeFrameDialog(); 								d.setText(MESSAGES.dialogAssistant()); 								d.setEscapeToHide(true); 								d.setFrameUrl("gwt.jsp?page=sectioning&session=" + iSessionId + "&student=" + event.getData().getStudent().getExternalId() + "&menu=hide&noCacheTS=" + new Date().getTime()); 								d.setFrameSize(dialog.getElement().getClientWidth() + "px", String.valueOf(Window.getClientHeight() * 9 / 10) + "px");  								dialog.hide(); 								d.center(); 								 								*/
name|UserAuthenticationProvider
name|user
init|=
operator|new
