...
condition|)
block|{
comment|//iSubjectArea.getWidget().set
block|}
else|else
block|{
name|iSubjectArea
...
argument_list|()
expr_stmt|;
comment|//iCatalogLinkLabel.setStyleName("unitime-SimpleLink");
name|iCatalogLinkLabelLine
operator|=
name|iPanel
operator|.
...
expr_stmt|;
comment|//TODO
comment|//Begin Coordinators section TODO
name|ClickHandler
...
argument_list|)
decl_stmt|;
comment|//instructorDropdown.setWidth(200);
name|UniTimeWidget
argument_list|<
name|UniTimeTextBox
argument_list|>
...
argument_list|)
expr_stmt|;
comment|//new UniTimeWidget<UniTimeTextBox>(new UniTimeTextBox(4, ValueBoxBase.TextAlignment.LEFT));
name|iNewEnrollmentDeadline
operator|.
name|addStyleName
argument_list|(
...
argument_list|)
decl_stmt|;
comment|//instructorDropdown.getWidget().setWidth("200px");
name|UniTimeWidget
argument_list|<
name|UniTimeTextBox
argument_list|>
...
argument_list|)
expr_stmt|;
comment|//Hide the instructors section - if its not empty?? Is that even possible? TODO
name|iPanel
operator|.
name|getRowFormatter
argument_list|()
...
argument_list|)
expr_stmt|;
comment|//Hide byReservationOnly and wk fields if empty? Can they be defaulted so that they are not empty when adding?
name|iPanel
operator|.
name|getRowFormatter
argument_list|()
...
literal|0
expr_stmt|;
comment|//result.getPrefRowsAdded();
name|constructInstructorsTable
argument_list|()
expr_stmt|;
for|for
...
block|{
name|String
name|selectedFundingDepartment
init|=
name|iFundingDepartment
operator|.
name|getWidget
...
argument_list|)
expr_stmt|;
comment|//iPanel.getRowFormatter().setVisible(iScheduleNoteLine, false);
name|iPanel
operator|.
name|getRowFormatter
argument_list|()
...
condition|)
block|{
comment|//Make byReservationOnly and wk stuff not editable TODO
comment|//And hide the notes section??? TODO
name|iPanel
operator|.
name|getRowFormatter
argument_list|()
...
argument_list|)
expr_stmt|;
comment|//Hide byReservationOnly?
name|iPanel
operator|.
name|getRowFormatter
argument_list|()
...
argument_list|)
decl_stmt|;
comment|//						if (courseOffering.getCoordinators().size()> i) {
comment|//							//Expand the Instructor table?
