...
specifier|private
name|int
name|iPictureHeaderRow
decl_stmt|,
name|iPictureUploadRow
decl_stmt|;
specifier|public
name|RoomEdit
parameter_list|(
...
name|setMarker
parameter_list|()
comment|/*-{ 		try { 			var x = $doc.getElementById("coordX").value; 			var y = $doc.getElementById("coordY").value; 			if (x&& y) { 				var pos = new $wnd.google.maps.LatLng(x, y); 				$wnd.marker.setPosition(pos); 				$wnd.marker.setVisible(true); 				if ($wnd.marker.getMap().getZoom()<= 10) $wnd.marker.getMap().setZoom(16); 				$wnd.marker.getMap().panTo(pos); 			} else { 				$wnd.marker.setVisible(false); 			} 			$wnd.marker.setDraggable(this.@org.unitime.timetable.gwt.client.rooms.RoomEdit::isGoogleMapEditable()()); 		} catch (error) {} 	}-*/
function_decl|;
specifier|protected
specifier|native
name|void
