...
name|DefaultMessage
argument_list|(
literal|"&copy; 2008 - 2022 The Apereo Foundation,<br>distributed under the Apache License, Version 2."
argument_list|)
name|String
name|pageCopyright
parameter_list|()
...
name|DefaultMessage
argument_list|(
literal|"UniTime {0}, \u00A9 2008 - 2022 The Apereo Foundation, distributed under the Apache License."
argument_list|)
name|String
name|pdfCopyright
parameter_list|(
...
name|DefaultMessage
argument_list|(
literal|"Edit Course Offering New"
argument_list|)
name|String
name|buttonEditCourseOffering
parameter_list|()
function_decl|;
annotation|@
name|DefaultMessage
...
name|DefaultMessage
argument_list|(
literal|"<b>{0}</b> can not be greater than<b>{1}</b> characters."
argument_list|)
name|String
name|errorMaxlength
parameter_list|(
...
name|DefaultMessage
argument_list|(
literal|"Title is required."
argument_list|)
name|String
name|errorTitleIsEmpty
parameter_list|()
function_decl|;
annotation|@
name|DefaultMessage
...
name|DefaultMessage
argument_list|(
literal|"Abbreviation must be unique."
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Consent of Department"
argument_list|)
name|String
name|consentDepartment
parameter_list|()
function_decl|;
annotation|@
name|DefaultMessage
argument_list|(
literal|"Consent of Instructor"
argument_list|)
name|String
name|consentInstructor
parameter_list|()
function_decl|;
annotation|@
name|DefaultMessage
...
name|DefaultMessage
argument_list|(
literal|"Students are allowed to enroll in this course up to {0} week of classes."
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Students are allowed to change existing enrollments up to {0} week of classes."
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Students are allowed to drop from this course up to {0} week of classes."
argument_list|)
name|String
...
argument_list|)
name|String
name|buttonDepartmentsUpdateData
parameter_list|()
function_decl|;
annotation|@
name|DefaultMessage
...
name|DefaultMessage
argument_list|(
literal|"Update room coordinates to match the building coordinates."
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"The department will be deleted. Continue?"
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Update data has failed: {0}"
argument_list|)
name|String
name|failedDepartmentUpdateData
parameter_list|(
name|String
name|reason
parameter_list|)
...
name|DefaultMessage
argument_list|(
literal|"Part_of_LLR_or_LALR_Pool"
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Event_Type_Description"
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"_Standard_Weekday_Hours"
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Station_Occupancy_Rate"
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Requested_Station_Occupancy_Rate"
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Traditional Utilization"
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"CheckConflicts"
argument_list|)
name|String
name|colCheckConflicts
parameter_list|()
function_decl|;
annotation|@
name|DefaultMessage
...
argument_list|)
name|String
name|colDisplayInstructors
parameter_list|()
function_decl|;
annotation|@
name|DefaultMessage
argument_list|(
literal|"Course Supervisor / Student System Access:"
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Instructional Offering Config Unique Id"
argument_list|)
name|String
name|fieldConfigUid
parameter_list|()
...
name|DefaultMessage
argument_list|(
literal|"Add Additional Instructor Row"
argument_list|)
name|String
name|fieldAdd
parameter_list|()
...
name|DefaultMessage
argument_list|(
literal|"Insert a new row below this row."
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"First Record For Class UniqueId"
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Instructional offering configuration id not provided."
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Instructional offering configuration with matching unique id not found."
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"User does not have permission to remove all instructors."
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Missing data for class: {0}"
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Duplicate instructor {0} with same responsibility {1} for class. {2}"
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Failed to Send Update to External System:  {0} = {1}"
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Wait-listing is enabled for this offering."
argument_list|)
name|String
...
name|DefaultMessage
argument_list|(
literal|"Wait-listing is not enabled for this offering."
argument_list|)
name|String
