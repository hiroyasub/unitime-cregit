...
name|error
argument_list|(
literal|"Unable to look up external variable title data."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|IllegalArgumentException
argument_list|(
literal|"Unable to look up external variable title data.  Unable to instantiate lookup class."
argument_list|)
throw|;
block|}
if|if
...
name|IllegalArgumentException
argument_list|(
literal|"Course for provided subject area and course number is not a variable title course."
argument_list|)
throw|;
block|}
block|}
...
expr_stmt|;
block|}
comment|// Notify the online scheduling server that the variable course title has changed
name|OnlineSectioningServer
name|server
init|=
name|getOnlineSectioningServer
argument_list|(
name|instructionalOffering
operator|.
name|getSessionId
...
condition|)
block|{
comment|// Online student scheduling server is ready, immediately reload the offering
name|server
operator|.
name|execute
argument_list|(
...
block|{
comment|// Online student scheduling server is not loaded or not ready, just create a notification
name|StudentSectioningQueue
operator|.
