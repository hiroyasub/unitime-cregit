...
name|Service
argument_list|(
literal|"/api/instructor-schedule"
argument_list|)
specifier|public
class|class
name|InstructorScheduleConnector
extends|extends
name|ApiConnector
block|{
annotation|@
...
name|createQuery
argument_list|(
literal|"from DepartmentalInstructor d where d.externalUniqueId = :externalId"
argument_list|)
operator|.
name|setString
argument_list|(
...
name|createQuery
argument_list|(
literal|"from DepartmentalInstructor d where d.externalUniqueId = :externalId and department.session.uniqueId = :sessionId"
argument_list|)
operator|.
name|setString
argument_list|(
