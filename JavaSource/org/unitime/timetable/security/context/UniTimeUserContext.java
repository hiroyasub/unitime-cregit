...
name|createQuery
argument_list|(
literal|"from Advisor where externalUniqueId = :id"
argument_list|)
operator|.
name|setString
argument_list|(
...
expr_stmt|;
block|}
comment|// multiple initiatives& no matching primary -> no default
if|if
condition|(
name|multipleInitiatives
operator|&&
