...
name|createQuery
argument_list|(
literal|"select x from Exam x where x.session.uniqueId=:sessionId"
argument_list|)
operator|.
name|setLong
argument_list|(
...
operator|+
literal|"o.course.subjectArea.uniqueId=:subjectAreaId"
argument_list|)
operator|.
name|setLong
argument_list|(
...
literal|"select distinct x from Exam x inner join x.owners o where "
operator|+
literal|"o.course.uniqueId=:courseOfferingId"
argument_list|)
operator|.
name|setLong
argument_list|(
...
name|nrStudents
return|;
comment|/*         return ((Number)new ExamDAO().getSession().createQuery(                 "select count(distinct e.student) from " +                 "StudentClassEnrollment e inner join e.clazz c " +                 "inner join c.schedulingSubpart.instrOfferingConfig ioc " +                 "inner join e.courseOffering co "+                 "inner join co.instructionalOffering io, " +                 "Exam x inner join x.owners o "+                 "where x.uniqueId=:examId and ("+                 "(o.ownerType="+ExamOwner.sOwnerTypeCourse+" and o.ownerId=co.uniqueId) or "+                 "(o.ownerType="+ExamOwner.sOwnerTypeOffering+" and o.ownerId=io.uniqueId) or "+                 "(o.ownerType="+ExamOwner.sOwnerTypeConfig+" and o.ownerId=ioc.uniqueId) or "+                 "(o.ownerType="+ExamOwner.sOwnerTypeClass+" and o.ownerId=c.uniqueId) "+                 ")")                 .setLong("examId", getUniqueId())                 .setCacheable(true)                 .uniqueResult()).intValue();                 */
block|}
specifier|public
name|Set
...
operator|+
literal|"r.uniqueId=:locationId and x.assignedPeriod!=null"
argument_list|)
operator|.
name|setLong
argument_list|(
...
operator|+
literal|"i.uniqueId=:instructorId and x.assignedPeriod!=null"
argument_list|)
operator|.
name|setLong
argument_list|(
