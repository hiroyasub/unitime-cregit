...
specifier|static
name|String
name|getSchedulingRoomTypeName
parameter_list|(
name|Integer
name|typeInt
parameter_list|)
...
case|:
return|return
literal|"Computing Labs"
return|;
case|case
literal|3
case|:
return|return
literal|"Departmental Rooms"
return|;
case|case
literal|4
case|:
...
name|createQuery
argument_list|(
literal|"select room from Location as room where room.session.uniqueId = :sessionId and room.examType in ("
operator|+
name|sExamLocationTypeFinal
operator|+
literal|","
...
name|createQuery
argument_list|(
literal|"select room from Location as room where room.session.uniqueId = :sessionId and room.examType != "
operator|+
name|sExamLocationTypeNone
argument_list|)
operator|.
