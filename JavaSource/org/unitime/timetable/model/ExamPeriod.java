...
name|getProperty
argument_list|(
literal|"tmtbl.room.availability.breakTime.start"
argument_list|,
literal|"0"
argument_list|)
argument_list|)
...
name|getProperty
argument_list|(
literal|"tmtbl.room.availability.breakTime.stop"
argument_list|,
literal|"0"
argument_list|)
argument_list|)
...
name|getQuery
argument_list|(
literal|"select min(ep.dateOffset), min(ep.startSlot), max(ep.dateOffset), max(ep.startSlot+ep.length) "
operator|+
