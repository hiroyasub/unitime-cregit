...
name|createQuery
argument_list|(
literal|"select e from Event e inner join e.relatedCourses r where "
operator|+
literal|"r.ownerId=:clazzId and r.ownerType=:ownerType and e.eventType.reference=:eventType"
argument_list|)
operator|.
name|setLong
argument_list|(
