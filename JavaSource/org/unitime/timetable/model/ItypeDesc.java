...
return|;
block|}
comment|/**      * Returns the ItypeDesc object corresponding to the given itype      * @param itype      * @return      * @throws Exception      */
specifier|public
specifier|static
name|ItypeDesc
name|find
...
name|createQuery
argument_list|(
literal|"select i from ItypeDesc i where i.itype=:itype"
argument_list|)
decl_stmt|;
name|q
operator|.
