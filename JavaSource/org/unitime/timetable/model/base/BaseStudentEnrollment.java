...
begin_comment
comment|/**  * This is an object that contains data related to the STUDENT_ENRL table.  * Do not modify this class because it will be overwritten if the configuration file  * related to this class is modified.  *  * @hibernate.class  *  table="STUDENT_ENRL"  */
end_comment
...
name|REF
init|=
literal|"StudentEnrollment"
decl_stmt|;
specifier|public
specifier|static
name|String
name|PROP_STUDENT_ID
init|=
literal|"studentId"
decl_stmt|;
...
return|;
block|}
comment|/** 	 * Set the value related to the column: STUDENT_ID 	 * @param studentId the STUDENT_ID value 	 */
specifier|public
name|void
name|setStudentId
parameter_list|(
