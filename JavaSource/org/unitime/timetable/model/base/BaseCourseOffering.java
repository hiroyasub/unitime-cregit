...
expr_stmt|;
block|}
comment|/** 	 * Return the value associated with the column: LASTLIKE_DEMAND 	 */
specifier|public
name|java
operator|.
name|lang
...
return|;
block|}
comment|/** 	 * Set the value related to the column: LASTLIKE_DEMAND 	 * @param demand the LASTLIKE_DEMAND value 	 */
specifier|public
name|void
name|setDemand
parameter_list|(
