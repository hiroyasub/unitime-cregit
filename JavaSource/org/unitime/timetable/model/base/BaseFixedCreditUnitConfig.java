...
name|fixedUnits
decl_stmt|;
comment|/** 	 * Return the value associated with the column: FIXED_UNITS 	 */
specifier|public
name|java
operator|.
name|lang
...
return|;
block|}
comment|/** 	 * Set the value related to the column: FIXED_UNITS 	 * @param fixedUnits the FIXED_UNITS value 	 */
specifier|public
name|void
name|setFixedUnits
parameter_list|(
