...
begin_comment
comment|/**  * This is an object that contains data related to the STUDENT_ENRL_MSG table.  * Do not modify this class because it will be overwritten if the configuration file  * related to this class is modified.  *  * @hibernate.class  *  table="STUDENT_ENRL_MSG"  */
end_comment
...
expr_stmt|;
block|}
comment|/** 	 * Return the value associated with the column: MSG_LEVEL 	 */
specifier|public
name|java
operator|.
name|lang
...
return|;
block|}
comment|/** 	 * Set the value related to the column: MSG_LEVEL 	 * @param level the MSG_LEVEL value 	 */
specifier|public
name|void
name|setLevel
parameter_list|(
