...
begin_comment
comment|/**  * This is an object that contains data related to the POS_MAJOR table.  * Do not modify this class because it will be overwritten if the configuration file  * related to this class is modified.  *  * @hibernate.class  *  table="POS_MAJOR"  */
end_comment
...
expr_stmt|;
block|}
comment|/** 	 * Return the value associated with the column: academicAreas 	 */
specifier|public
name|java
operator|.
name|util
...
return|;
block|}
comment|/** 	 * Set the value related to the column: academicAreas 	 * @param academicAreas the academicAreas value 	 */
specifier|public
name|void
