...
name|Session
argument_list|>
name|findByDefaultInstructionalMethod
parameter_list|(
name|org
operator|.
name|hibernate
...
parameter_list|,
name|Long
name|defaultInstructionalMethodId
parameter_list|)
block|{
return|return
name|hibSession
...
name|createQuery
argument_list|(
literal|"from Session x where x.defaultInstructionalMethod.uniqueId = :defaultInstructionalMethodId"
argument_list|)
operator|.
name|setLong
argument_list|(
literal|"defaultInstructionalMethodId"
argument_list|,
name|defaultInstructionalMethodId
argument_list|)
operator|.
