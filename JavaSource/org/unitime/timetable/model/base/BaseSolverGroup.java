...
begin_comment
comment|/**  * This is an object that contains data related to the SOLVER_GROUP table.  * Do not modify this class because it will be overwritten if the configuration file  * related to this class is modified.  *  * @hibernate.class  *  table="SOLVER_GROUP"  */
end_comment
...
expr_stmt|;
block|}
comment|/** 	 * Return the value associated with the column: solutions 	 */
specifier|public
name|java
operator|.
name|util
...
return|;
block|}
comment|/** 	 * Set the value related to the column: solutions 	 * @param solutions the solutions value 	 */
specifier|public
name|void
name|setSolutions
parameter_list|(
