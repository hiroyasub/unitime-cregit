...
begin_comment
comment|/**  * This is an object that contains data related to the ROOM_GROUP table.  * Do not modify this class because it will be overwritten if the configuration file  * related to this class is modified.  *  * @hibernate.class  *  table="ROOM_GROUP"  */
end_comment
...
expr_stmt|;
block|}
comment|/** 	 * Return the value associated with the column: GLOBAL 	 */
specifier|public
name|java
operator|.
name|lang
...
return|;
block|}
comment|/** 	 * Set the value related to the column: GLOBAL 	 * @param global the GLOBAL value 	 */
specifier|public
name|void
name|setGlobal
parameter_list|(
...
expr_stmt|;
block|}
comment|/** 	 * Return the value associated with the column: DEFAULT_GROUP 	 */
specifier|public
name|java
operator|.
name|lang
...
return|;
block|}
comment|/** 	 * Set the value related to the column: DEFAULT_GROUP 	 * @param defaultGroup the DEFAULT_GROUP value 	 */
specifier|public
name|void
name|setDefaultGroup
parameter_list|(
