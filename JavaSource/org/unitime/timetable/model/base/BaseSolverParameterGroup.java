...
begin_comment
comment|/**  * This is an object that contains data related to the SOLVER_PARAMETER_GROUP table.  * Do not modify this class because it will be overwritten if the configuration file  * related to this class is modified.  *  * @hibernate.class  *  table="SOLVER_PARAMETER_GROUP"  */
end_comment
...
expr_stmt|;
block|}
comment|/** 	 * Return the value associated with the column: CONDITION 	 */
specifier|public
name|java
operator|.
name|lang
...
return|;
block|}
comment|/** 	 * Set the value related to the column: CONDITION 	 * @param condition the CONDITION value 	 */
specifier|public
name|void
name|setCondition
parameter_list|(
