...
name|createQuery
argument_list|(
literal|"from CurriculumCourse x where x.classification.uniqueId = :classificationId"
argument_list|)
operator|.
name|setLong
argument_list|(
literal|"classificationId"
argument_list|,
name|classificationId
argument_list|)
operator|.
...
name|createQuery
argument_list|(
literal|"from CurriculumCourse x where x.course.uniqueId = :courseId"
argument_list|)
operator|.
name|setLong
argument_list|(
