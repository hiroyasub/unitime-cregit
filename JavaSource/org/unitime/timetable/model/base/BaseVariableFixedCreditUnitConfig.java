...
name|maxUnits
decl_stmt|;
comment|/** 	 * Return the value associated with the column: MIN_UNITS 	 */
specifier|public
name|java
operator|.
name|lang
...
return|;
block|}
comment|/** 	 * Set the value related to the column: MIN_UNITS 	 * @param minUnits the MIN_UNITS value 	 */
specifier|public
name|void
name|setMinUnits
parameter_list|(
...
expr_stmt|;
block|}
comment|/** 	 * Return the value associated with the column: MAX_UNITS 	 */
specifier|public
name|java
operator|.
name|lang
...
return|;
block|}
comment|/** 	 * Set the value related to the column: MAX_UNITS 	 * @param maxUnits the MAX_UNITS value 	 */
specifier|public
name|void
name|setMaxUnits
parameter_list|(
