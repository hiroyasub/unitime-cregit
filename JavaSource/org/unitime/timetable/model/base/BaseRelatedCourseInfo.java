...
begin_comment
comment|/**  * This is an object that contains data related to the RELATED_COURSE_INFO table.  * Do not modify this class because it will be overwritten if the configuration file  * related to this class is modified.  *  * @hibernate.class  *  table="RELATED_COURSE_INFO"  */
end_comment
...
return|;
block|}
comment|/** 	 * Set the value related to the column: OWNER_ID 	 * @param ownerId the OWNER_ID value 	 */
specifier|public
name|void
name|setOwnerId
parameter_list|(
...
expr_stmt|;
block|}
comment|/** 	 * Return the value associated with the column: OWNER_TYPE 	 */
specifier|public
name|java
operator|.
name|lang
...
return|;
block|}
comment|/** 	 * Set the value related to the column: OWNER_TYPE 	 * @param ownerType the OWNER_TYPE value 	 */
specifier|public
name|void
name|setOwnerType
parameter_list|(
