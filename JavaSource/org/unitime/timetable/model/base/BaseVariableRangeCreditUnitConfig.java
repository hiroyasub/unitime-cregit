...
name|REF
init|=
literal|"VariableRangeCreditUnitConfig"
decl_stmt|;
specifier|public
specifier|static
name|String
name|PROP_FRACTIONAL_INCREMENTS_ALLOWED
init|=
literal|"fractionalIncrementsAllowed"
decl_stmt|;
...
decl_stmt|;
comment|/** 	 * Return the value associated with the column: FRACTIONAL_INCR_ALLOWED 	 */
specifier|public
name|java
operator|.
name|lang
...
return|;
block|}
comment|/** 	 * Set the value related to the column: FRACTIONAL_INCR_ALLOWED 	 * @param fractionalIncrementsAllowed the FRACTIONAL_INCR_ALLOWED value 	 */
specifier|public
name|void
