...
begin_comment
comment|/**  * This is an object that contains data related to the DATE_PATTERN table.  * Do not modify this class because it will be overwritten if the configuration file  * related to this class is modified.  *  * @hibernate.class  *  table="DATE_PATTERN"  */
end_comment
...
expr_stmt|;
block|}
comment|/** 	 * Return the value associated with the column: OFFSET 	 */
specifier|public
name|java
operator|.
name|lang
...
return|;
block|}
comment|/** 	 * Set the value related to the column: OFFSET 	 * @param offset the OFFSET value 	 */
specifier|public
name|void
name|setOffset
parameter_list|(
