...
expr_stmt|;
block|}
comment|/** 	 * Return the value associated with the column: preferences 	 */
specifier|public
name|java
operator|.
name|util
...
return|;
block|}
comment|/** 	 * Set the value related to the column: preferences 	 * @param preferences the preferences value 	 */
specifier|public
name|void
name|setPreferences
parameter_list|(
