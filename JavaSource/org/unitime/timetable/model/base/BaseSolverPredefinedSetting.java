...
begin_comment
comment|/**  * This is an object that contains data related to the SOLVER_PREDEF_SETTING table.  * Do not modify this class because it will be overwritten if the configuration file  * related to this class is modified.  *  * @hibernate.class  *  table="SOLVER_PREDEF_SETTING"  */
end_comment
...
expr_stmt|;
block|}
comment|/** 	 * Return the value associated with the column: APPEARANCE 	 */
specifier|public
name|java
operator|.
name|lang
...
return|;
block|}
comment|/** 	 * Set the value related to the column: APPEARANCE 	 * @param appearance the APPEARANCE value 	 */
specifier|public
name|void
name|setAppearance
parameter_list|(
