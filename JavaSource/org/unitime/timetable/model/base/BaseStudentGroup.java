...
begin_comment
comment|/**  * This is an object that contains data related to the STUDENT_GROUP table.  * Do not modify this class because it will be overwritten if the configuration file  * related to this class is modified.  *  * @hibernate.class  *  table="STUDENT_GROUP"  */
end_comment
...
expr_stmt|;
block|}
comment|/** 	 * Return the value associated with the column: GROUP_ABBREVIATION 	 */
specifier|public
name|java
operator|.
name|lang
...
return|;
block|}
comment|/** 	 * Set the value related to the column: GROUP_ABBREVIATION 	 * @param groupAbbreviation the GROUP_ABBREVIATION value 	 */
specifier|public
name|void
name|setGroupAbbreviation
parameter_list|(
...
expr_stmt|;
block|}
comment|/** 	 * Return the value associated with the column: GROUP_NAME 	 */
specifier|public
name|java
operator|.
name|lang
...
return|;
block|}
comment|/** 	 * Set the value related to the column: GROUP_NAME 	 * @param groupName the GROUP_NAME value 	 */
specifier|public
name|void
name|setGroupName
parameter_list|(
