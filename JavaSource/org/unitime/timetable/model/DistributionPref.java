...
literal|false
return|;
comment|//preference owner by the given manager
if|if
condition|(
name|manager
operator|.
...
return|;
block|}
comment|//else -> class manager of all classes / subparts
if|if
condition|(
name|d
operator|.
...
literal|true
return|;
comment|//LLR/LAB manager or schedule deputy edit phase -> ownership or controlling course offering manager of one class is enough
if|if
condition|(
operator|!
name|department
