...
literal|null
expr_stmt|;
comment|// if section swap and the enrollment does not meet requirements -> not enrolled
name|CourseOffering
name|lastSwap
init|=
operator|(
...
condition|)
block|{
comment|// requirements not met -> put back (it is considered not enrolled)
name|waitlists
operator|.
name|put
argument_list|(
