...
argument_list|)
return|;
comment|/*         Object owner = getOwnerObject();         switch (getOwnerType()) {             case sOwnerTypeClass :                                   return ((Class_)owner).getClassLabel();             case sOwnerTypeConfig :                  return ((InstrOfferingConfig)owner).toString();             case sOwnerTypeCourse :                  return ((CourseOffering)owner).getCourseName();             case sOwnerTypeOffering :                  return ((InstructionalOffering)owner).getCourseName();             default : throw new RuntimeException("Unknown owner type "+getOwnerType());         }         */
block|}
specifier|public
name|String
name|getSubject
