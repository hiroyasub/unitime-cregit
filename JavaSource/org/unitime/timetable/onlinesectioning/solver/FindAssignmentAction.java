...
block|}
block|}
comment|/* 		DataProperties config = new DataProperties(server.getConfig()); 		config.setProperty("Neighbour.BranchAndBoundTimeout", "-1"); 		BranchBoundSelection selection = new BranchBoundSelection(config); 		selection.setModel(model); 		BranchBoundNeighbour neighbour = selection.getSelection(assignment, student).select(); 		*/
name|OnlineSectioningSelection
name|selection
init|=
literal|null
