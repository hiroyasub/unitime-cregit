...
name|getPropertyBoolean
argument_list|(
literal|"FindAssignment.CheckDeadlines"
argument_list|,
literal|false
argument_list|)
operator|&&
...
name|getPropertyBoolean
argument_list|(
literal|"FindAssignment.AvoidPastSections"
argument_list|,
literal|true
argument_list|)
condition|)
...
name|getPropertyInt
argument_list|(
literal|"FindAssignment.AvoidPastOffset"
argument_list|,
literal|0
argument_list|)
expr_stmt|;
...
name|getPropertyBoolean
argument_list|(
literal|"Load.OnlineOnlyAdminOverride"
argument_list|,
literal|false
argument_list|)
condition|)
...
name|getPropertyBoolean
argument_list|(
literal|"Load.OnlineOnlyAdvisorOverride"
argument_list|,
literal|false
argument_list|)
condition|)
...
argument_list|)
expr_stmt|;
comment|/* 					if (rp != null&& rp.getRequest().getWaitListSwapWithCourseOfferingId() != null&& rp.getRequest().getWaitListSwapWithCourseOfferingId().equals(enrollment.getCourse().getId())) { 						if (isRequired(enrollment, rp.getRequest())) 							ca.setEnrollmentMessage(MSG.waitListRequirementsMet()); 					} 					*/
block|}
name|ret
operator|.
name|add
