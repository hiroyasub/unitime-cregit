...
name|println
argument_list|(
literal|"<tr><td style=\"font-size: 9pt; font-style: italic; color: #9CB0CE; text-align: right; margin-top: -2px; white-space: nowrap;\">"
argument_list|)
expr_stmt|;
name|out
operator|.
name|println
argument_list|(
literal|"		If the timetable is not displayed correctly, please check out the attached file."
argument_list|)
expr_stmt|;
name|out
operator|.
