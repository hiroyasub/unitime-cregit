...
name|println
argument_list|(
literal|"<tr><td>This email was send on behalf of "
operator|+
name|helper
operator|.
name|getUser
...
name|style
operator|+
literal|"\" colspan=\"8\" align=\"center\">wait-listed alternative</td>"
argument_list|)
expr_stmt|;
else|else
name|out
...
name|style
operator|+
literal|"\" colspan=\"8\" align=\"center\">wait-listed</td>"
argument_list|)
expr_stmt|;
name|out
operator|.
...
name|println
argument_list|(
literal|"<table width=\"100%\"><tr><td class=\"unitime-ErrorMessage\">You have not been granted the "
operator|+
name|consent
operator|.
name|toLowerCase
argument_list|()
operator|+
literal|", please contact your advisor for further information.</td></tr></table>"
argument_list|)
expr_stmt|;
block|}
name|out
