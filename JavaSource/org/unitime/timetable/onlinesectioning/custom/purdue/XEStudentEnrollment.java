...
name|debug
argument_list|(
literal|"Retrieving enrollment for "
operator|+
name|student
operator|.
name|getName
...
name|warn
argument_list|(
literal|"Failed to retrieve student registration data from Banner: "
operator|+
name|e
operator|.
name|getMessage
...
argument_list|()
expr_stmt|;
comment|// XStudentId student = new XStudentId(-1l, "PURDUE001", "Purdue Student");
name|Map
argument_list|<
name|Long
argument_list|,
...
argument_list|()
decl_stmt|;
comment|/* 			xe.enroll( 					new AcademicSessionInfo(-1l, "2014", "Fall", "M"), 					student,  					"111111", 					enrollments); 			xe.enroll( 					new AcademicSessionInfo(-1l, "2014", "Fall", "M"), 					student,  					"111111", 					new HashMap<Long, List<XSection>>()); 					*/
name|ClientResource
name|resource
init|=
operator|new
