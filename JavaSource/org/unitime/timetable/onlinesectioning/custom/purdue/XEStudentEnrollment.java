...
name|getProperty
argument_list|(
literal|"banner.xe.advisorIsAdmin"
argument_list|,
literal|"false"
argument_list|)
argument_list|)
...
name|createQuery
argument_list|(
literal|"select count(s) from Student s where s.externalUniqueId = :id and "
operator|+
literal|"s.session.academicYear = :year and s.session.academicTerm = :term and s.session.academicInitiative != :campus"
argument_list|)
operator|.
name|setString
argument_list|(
