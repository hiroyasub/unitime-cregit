...
specifier|protected
name|boolean
name|isIngoreLCRegistrationErrors
parameter_list|()
block|{
return|return
literal|"true"
...
name|getProperty
argument_list|(
literal|"purdue.specreg.ignoreLCerrors"
argument_list|,
literal|"false"
argument_list|)
argument_list|)
...
name|getProperty
argument_list|(
literal|"purdue.specreg.canChangeNote"
argument_list|,
literal|"true"
argument_list|)
argument_list|)
...
specifier|protected
name|String
name|getOverrideNotNeededReasonRegExp
parameter_list|()
block|{
return|return
name|ApplicationProperties
...
name|getProperty
argument_list|(
literal|"purdue.specreg.overrideNotNeededRegExp"
argument_list|,
literal|"Denying as override is not required\\."
argument_list|)
return|;
block|}
specifier|protected
...
block|}
block|}
comment|// Inconsistent requirements
name|boolean
name|questionInconStuPref
init|=
literal|false
decl_stmt|;
for|for
...
argument_list|,
literal|"Important course has been removed."
argument_list|)
operator|.
name|replace
argument_list|(
...
literal|"purdue.specreg.messages.courseDropCrit"
argument_list|,
literal|"Vital course has been removed."
argument_list|)
operator|.
name|replace
argument_list|(
...
argument_list|,
literal|"Missing important course that has been recommended by the advisor."
argument_list|)
operator|.
name|replace
argument_list|(
...
literal|"purdue.specreg.messages.courseMissingAdvisedCritical"
argument_list|,
literal|"Missing vital course that has been recommended by the advisor."
argument_list|)
operator|.
name|replace
argument_list|(
...
name|getProperty
argument_list|(
literal|"purdue.specreg.messages.courseRequestNote"
argument_list|,
...
name|getProperty
argument_list|(
literal|"purdue.specreg.prereg.requestorNoteSuggestions"
argument_list|,
literal|""
argument_list|)
operator|.
...
operator|)
operator|+
literal|"One or more courses are not available due to the selected preferences."
argument_list|)
argument_list|,
name|CONF_UNITIME
argument_list|,
...
operator|)
operator|+
literal|"One or more vital courses have been removed. This may prohibit progress towards degree. Please consult with your academic advisor."
argument_list|)
argument_list|,
name|CONF_UNITIME
argument_list|,
...
operator|)
operator|+
literal|"One or more important courses have been removed. This may prohibit progress towards degree. Please consult with your academic advisor."
argument_list|)
argument_list|,
name|CONF_UNITIME
argument_list|,
...
operator|)
operator|+
literal|"One or more critical courses have been removed. This may prohibit progress towards degree. Please consult with your academic advisor."
argument_list|)
argument_list|,
name|CONF_UNITIME
argument_list|,
...
operator|)
operator|+
literal|"One or more courses that are marked by your advisor as important have not been requested. This may prohibit progress towards degree. Please see you advisor course requests and/or consult with your academic advisor."
argument_list|)
argument_list|,
name|CONF_UNITIME
argument_list|,
...
operator|)
operator|+
literal|"One or more courses that are marked by your advisor as vital have not been requested. This may prohibit progress towards degree. Please see you advisor course requests and/or consult with your academic advisor."
argument_list|)
argument_list|,
name|CONF_UNITIME
argument_list|,
...
operator|)
operator|+
literal|"One or more courses that are marked by your advisor as critical have not been requested. This may prohibit progress towards degree. Please see you advisor course requests and/or consult with your academic advisor."
argument_list|)
argument_list|,
name|CONF_UNITIME
argument_list|,
...
name|getProperty
argument_list|(
literal|"purdue.specreg.messages.acr.maxCreditDeniedError"
argument_list|,
...
name|getProperty
argument_list|(
literal|"purdue.specreg.messages.acr.deniedOverrides"
argument_list|,
literal|"One or more courses require registration overrides which have been denied. The student will not be able to request these."
argument_list|)
argument_list|,
name|CONF_BANNER
argument_list|,
...
name|getProperty
argument_list|(
literal|"purdue.specreg.messages.acr.requestOverrides"
argument_list|,
operator|(
name|idx
operator|==
...
operator|)
operator|+
literal|"The student may need to request overrides for the above registration errors. Do you want to proceed?"
argument_list|)
argument_list|,
name|CONF_BANNER
argument_list|,
...
name|getProperty
argument_list|(
literal|"purdue.specreg.messages.acr.timeConflicts"
argument_list|,
operator|(
name|line
operator|>
...
operator|)
operator|+
literal|"Two or more single section courses are conflicting with each other. The student will likely not be able to get the conflicting course, so please provide an alternative course if possible."
argument_list|)
argument_list|,
name|CONF_UNITIME
argument_list|,
...
name|getProperty
argument_list|(
literal|"purdue.specreg.messages.acr.inconsistentStudPref"
argument_list|,
operator|(
name|line
operator|>
...
name|getProperty
argument_list|(
literal|"purdue.specreg.confirm.acr.unitimeContinueButton"
argument_list|,
literal|"Accept& Continue"
argument_list|)
else|:
...
name|getProperty
argument_list|(
literal|"purdue.specreg.confirm.acr.unitimeContinueButtonTitle"
argument_list|,
literal|"Accept the above warning(s) and continue to submit the Advisor Course Recommendations"
argument_list|)
else|:
name|ApplicationProperties
operator|.
...
name|getProperty
argument_list|(
literal|"purdue.specreg.confirm.acr.bannerDialogName"
argument_list|,
...
name|getProperty
argument_list|(
literal|"purdue.specreg.confirm.acr.bannerYesButton"
argument_list|,
literal|"Accept& Submit"
argument_list|)
argument_list|,
...
name|getProperty
argument_list|(
literal|"purdue.specreg.confirm.acr.bannerNoButton"
argument_list|,
literal|"Cancel Submit"
argument_list|)
argument_list|,
...
name|getProperty
argument_list|(
literal|"purdue.specreg.confirm.acr.bannerYesButtonTitle"
argument_list|,
literal|"Accept the above warning(s) and submit the Advisor Course Recommendations"
argument_list|)
argument_list|,
...
name|getProperty
argument_list|(
literal|"purdue.specreg.confirm.acr.bannerNoButtonTitle"
argument_list|,
literal|"Go back to editing your Advisor Course Recommendations"
argument_list|)
argument_list|)
