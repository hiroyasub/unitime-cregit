...
argument_list|)
expr_stmt|;
comment|// !coursesWithNotAlt.contains(rc.getCourseId())
if|if
condition|(
operator|!
name|coursesWithNotAlt
...
argument_list|,
literal|"It is possible to request overrides for some of the above problems. Do you want to request overrides?"
argument_list|)
argument_list|)
expr_stmt|;
block|}
