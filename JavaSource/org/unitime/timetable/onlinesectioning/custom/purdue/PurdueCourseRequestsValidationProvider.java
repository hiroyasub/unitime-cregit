...
operator|+
literal|"registration in them please select YES to request overrides. If you arenât sure, click NO and\n"
operator|+
...
argument_list|,
literal|"Do you want to request overrides for the registration errors listed above?"
argument_list|)
argument_list|,
name|CONF_BANNER
argument_list|,
