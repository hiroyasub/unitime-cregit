...
argument_list|,
literal|"The request to increase the maximum credit hours to {maxCreditDenied} has been denied.\nYou must remove some course requests in order to submit your registration request."
argument_list|)
operator|.
name|replace
argument_list|(
...
name|getProperty
argument_list|(
literal|"purdue.specreg.messages.maxCreditDenied"
argument_list|,
literal|"Denied maximum of {max} credit hours exceeded."
argument_list|)
operator|.
name|replace
argument_list|(
...
name|getProperty
argument_list|(
literal|"purdue.specreg.messages.deniedMaxCreditOverrideError"
argument_list|,
literal|"The request to increase maximum credit hours has been denied.\nYou must remove some course requests in order to submit your registration request."
argument_list|)
argument_list|)
expr_stmt|;
block|}
