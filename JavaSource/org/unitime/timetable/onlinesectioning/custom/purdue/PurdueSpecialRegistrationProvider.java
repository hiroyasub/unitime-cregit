...
specifier|protected
name|String
name|getSpecialRegistrationApiSiteGetAll
parameter_list|()
block|{
return|return
name|ApplicationProperties
...
name|getProperty
argument_list|(
literal|"purdue.specreg.site.getall"
argument_list|,
name|getSpecialRegistrationApiSiteSubmit
argument_list|()
argument_list|)
...
specifier|protected
name|String
name|getSpecialRegistrationApiSiteCheck
parameter_list|()
block|{
return|return
name|ApplicationProperties
...
name|getProperty
argument_list|(
literal|"purdue.specreg.site.check"
argument_list|,
name|getSpecialRegistrationApiSiteGetAll
argument_list|()
argument_list|)
...
specifier|public
name|boolean
name|hasSpecialRegistrationRequests
parameter_list|(
name|OnlineSectioningServer
name|server
parameter_list|,
...
name|error
argument_list|(
literal|"Failed to check for open registrations: "
operator|+
name|e
operator|.
name|getMessage
...
name|error
argument_list|(
literal|"Failed to request special registrations: "
operator|+
name|e
operator|.
name|getMessage
