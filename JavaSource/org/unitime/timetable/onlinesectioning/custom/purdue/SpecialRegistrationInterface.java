...
name|courseNbr
decl_stmt|;
comment|/** Banner's campus (can be null in case of the MAXI error) */
specifier|public
name|String
name|bannerCourseCampus
decl_stmt|;
comment|/** Banner's subject area (can be null in case of the MAXI error) */
specifier|public
name|String
name|bannerSubject
decl_stmt|;
comment|/** Banner's course number (can be null in case of the MAXI error) */
specifier|public
name|String
name|bannerCourseNbr
decl_stmt|;
