...
name|getProperty
argument_list|(
literal|"banner.ucc.coursesSQLfull"
argument_list|,
literal|"select a.subject, a.course_number "
operator|+
literal|"from timetable.szv_utm_attr a where a.term_start<= :term and a.term_end>= :term and "
operator|+
literal|"(lower(a.attribute_description) = concat('uc-', :query) or lower(a.course_attribute) = :query)"
argument_list|)
return|;
block|}
specifier|protected
name|String
name|getCourseNamesPartialSQL
parameter_list|()
block|{
return|return
name|ApplicationProperties
...
name|getProperty
argument_list|(
literal|"banner.ucc.coursesSQLpartial"
argument_list|,
literal|"select a.subject, a.course_number "
operator|+
literal|"from timetable.szv_utm_attr a where a.term_start<= :term and a.term_end>= :term and "
operator|+
literal|"(lower(a.attribute_description) like concat(concat('uc-', :query), '%') or lower(a.attribute_description) like concat(concat('% ', :query), '%'))"
argument_list|)
return|;
block|}
specifier|protected
