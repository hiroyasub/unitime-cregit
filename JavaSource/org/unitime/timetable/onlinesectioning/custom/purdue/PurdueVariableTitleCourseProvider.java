...
argument_list|,
literal|"select subj_code, crse_numb, crse_title, credit_hr_ind, credit_hr_low, credit_hr_high, gmod_code, gmod_desc, gmod_default_ind "
operator|+
literal|"from timetable.szgv_reg_vartl_course where "
operator|+
literal|"concat(concat(subj_code, ' '), crse_numb) like :query and attr_code = 'VART' and "
operator|+
literal|"course_effective_term<= :term and :term< course_end_term and "
operator|+
literal|"attr_effective_term<= :term and :term< attr_end_term and "
operator|+
literal|"gmod_effective_term<= :term and :term< gmod_end_term "
operator|+
literal|"order by subj_code, crse_numb, gmod_code"
argument_list|)
return|;
block|}
specifier|protected
