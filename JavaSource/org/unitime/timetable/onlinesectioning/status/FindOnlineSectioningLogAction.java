...
argument_list|()
condition|?
literal|"<td class='top-border-dashed' colspan='4'>"
else|:
literal|"<td colspan='4'>"
operator|)
operator|+
name|CONST
operator|.
...
name|html
operator|+=
literal|"<tt><td class='top-border-dashed' colspan='6'>"
operator|+
name|creditNote
operator|+
literal|"</td></tr>"
...
name|html
operator|+=
literal|"<tr><td class='top-border-dashed' colspan='7'>"
operator|+
name|creditNote
operator|+
literal|"</td></tr>"
...
block|}
return|return
literal|"cr.courseOffering.uniqueId in ("
operator|+
name|ret
operator|+
literal|")"
