...
condition|)
block|{
comment|// skip course requests where course demand is enrolled to some other course
for|for
control|(
name|CourseRequest
name|x
...
argument_list|()
operator|.
name|isEnrolledExceptForWaitListSwap
argument_list|()
condition|)
block|{
name|tSwap
...
decl_stmt|;
name|int
name|notAssignedCrit
init|=
literal|0
decl_stmt|,
name|notAssignedPrim
init|=
literal|0
decl_stmt|;
for|for
