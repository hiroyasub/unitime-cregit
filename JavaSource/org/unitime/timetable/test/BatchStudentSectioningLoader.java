...
name|createQuery
argument_list|(
literal|"select co.uniqueId, count(d.uniqueId) from "
operator|+
literal|"CourseOffering co left join co.demandOffering cx, LastLikeCourseDemand d where co.subjectArea.session.uniqueId=:sessionId and "
operator|+
literal|"(( d.subjectArea=co.subjectArea and d.courseNbr=co.courseNbr ) or "
operator|+
