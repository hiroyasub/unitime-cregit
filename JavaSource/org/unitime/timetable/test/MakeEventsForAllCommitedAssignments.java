...
name|createQuery
argument_list|(
literal|"select distinct s from Solution s inner join s.assignments a where s.commited = true and a.event is null"
argument_list|)
operator|.
name|list
argument_list|()
...
operator|+
literal|"where a.event is null and a.solution.uniqueId = :solutionId"
argument_list|)
operator|.
name|setLong
argument_list|(
